# M5 shell-primitive release-proof fixtures

Protected, redaction-safe fixtures for the M5 shell-primitive release-proof certification capstone
(see
[`docs/shell/m5_shell_primitive_release_proof_contract.md`](../../../docs/shell/m5_shell_primitive_release_proof_contract.md)).

These files are minted by the headless emitter and asserted bit-for-bit equal to the seed by
`crates/aureline-shell/tests/m5_shell_primitive_release_proof_fixtures.rs`. Do not hand-edit;
regenerate with:
...
- `packet.json` — canonical certification packet (6 green, 4 yellow, 0 red).
