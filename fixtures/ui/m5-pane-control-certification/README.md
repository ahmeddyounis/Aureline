# M5 pane-control certification fixtures

Protected, redaction-safe fixtures for the M5 splitter & resizable-pane control
precision, proportion-safe persistence, default-size reset/restore & support-export
certification capstone (see
[`docs/shell/m5_pane_control_certification_contract.md`](../../../docs/shell/m5_pane_control_certification_contract.md)).

These files are minted by the headless emitter and asserted bit-for-bit equal to the
seed by `crates/aureline-shell/tests/m5_pane_control_certification_fixtures.rs`. Do not
...
- `packet.json` — canonical certification packet (2 green, 4 yellow, 0 red).
