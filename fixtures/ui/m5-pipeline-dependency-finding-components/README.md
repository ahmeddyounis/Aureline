...
| `annotation_row.json` | `schemas/ui/m5-annotation-row.schema.json` | A stale diagnostic annotation remains visible while suppressed until review, keeping severity, confidence, freshness, and remediation separate. |
