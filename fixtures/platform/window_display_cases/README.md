...
- which recovery actions and provenance details must stay visible.
...
| `fullscreen_snapped_restore_intent.json` | fullscreen/spaces/snap restore after reopen | dominant work mode intent returns without off-screen stranding |
