...
secret material. It proves the protected refactor, formatter, lockfile,
build-output, preview-regeneration, and AI-apply paths can share one
support-export-safe lineage envelope.
