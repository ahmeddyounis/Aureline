...
fn handoff_truth() -> ConsoleHandoffTruth {
    ConsoleHandoffTruth {
        ...
        handoff: ControlPlaneHandoff {
            ...
            handoff_reason: crate::ControlPlaneHandoffReason::MutationRequiresVendorConsole,
            destination_class: crate::ControlPlaneHandoffDestinationClass::VendorConsole,
            ...
            target_identity: crate::ControlPlaneTargetIdentity {
                target_label: "checkout rollout".to_string(),
                provider: "kubernetes".to_string(),
                account_subscription_project: "project:payments-prod".to_string(),
                cluster: Some("cluster:payments-us-1".to_string()),
                namespace_or_scope: Some("namespace:checkout".to_string()),
                region_zone: Some("us-west-2".to_string()),
                tenant: Some("tenant:payments".to_string()),
                stable_target_ref: "obj:k8s:checkout".to_string(),
                provider_handle_ref: Some("provider://checkout-rollout".to_string()),
            },
            authority_boundary: crate::ControlPlaneAuthorityBoundary {
                boundary_label: "Vendor console owns rollout mutation authority".to_string(),
                aureline_posture: crate::ActionPosture::HandoffOnly,
                destination_authority_label: "Vendor-owned rollout authority".to_string(),
            ...
            return_anchor: crate::ControlPlaneReturnAnchor {
                anchor_id: "anchor:checkout-rollout".to_string(),
                surface: crate::ControlPlaneReturnSurface::InfrastructurePanel,
                context_ref: "envctx:k8s:payments-prod:checkout".to_string(),
                primary_object_ref: "obj:k8s:checkout".to_string(),
                route_or_view_ref: "infra://checkout-rollout".to_string(),
                restore_action_label: "Return to infrastructure panel".to_string(),
                generic_shell_reopen_forbidden: true,
            },
            breadcrumbs: vec![
                crate::ControlPlaneBreadcrumb {
                    breadcrumb_id: "crumb:1".to_string(),
                    position: 1,
                    label: "checkout manifest".to_string(),
                    surface: crate::ControlPlaneReturnSurface::CodeBreadcrumb,
                    context_ref: "envctx:k8s:payments-prod:checkout".to_string(),
                    object_ref: "obj:k8s:authored".to_string(),
                },
                crate::ControlPlaneBreadcrumb {
                    breadcrumb_id: "crumb:2".to_string(),
                    position: 2,
                    label: "checkout resource".to_string(),
                    surface: crate::ControlPlaneReturnSurface::InfrastructurePanel,
                    context_ref: "envctx:k8s:payments-prod:checkout".to_string(),
                    object_ref: "obj:k8s:checkout".to_string(),
                },
            ],
