...
pub use queue_session_terminal_governance::{
    ...
    ActivityNextActionClass, BoundaryDisclosureClass as GovernanceBoundaryDisclosureClass,
    ...
    SchedulerLaneRetryStateClass, SheddingReasonClass as GovernanceSheddingReasonClass,
