...
pub mod add_shared_editor_gutter_test_tree_pr_review_cli_summary_support_export_and_imported_ci_consumers_so_test_intelligence_components_keep_scope_freshness_and_baseline_language_aligned_across_claimed_m5_profiles;
...
pub mod certify_coverage_summary_bar_coverage_overlay_marker_flaky_state_badge_retry_history_row_snapshot_review_card_coverage_import_merge_sheet_and_test_generation_suggestion_card_truth_on_every_claimed_m5_quality_surface;
...
pub mod certify_test_tree_row_inline_result_marker_session_summary_bar_watch_mode_banner_failure_triage_panel_quarantine_review_sheet_and_environment_matrix_card_truth_on_every_claimed_m5_test_surface;
...
pub mod freeze_the_m5_coverage_summary_bar_coverage_overlay_marker_flaky_state_badge_retry_history_row_snapshot_review_card_coverage_import_merge_sheet_and_test_generation_suggestion_card_component_matrix;
...
pub mod freeze_the_m5_test_tree_row_inline_result_marker_session_summary_bar_watch_mode_banner_failure_triage_panel_quarantine_review_sheet_and_environment_matrix_card_component_matrix;
...
pub mod implement_coverage_summary_bars_and_coverage_overlay_markers_with_included_run_provenance_line_versus_branch_or_partial_truth_changed_file_emphasis_and_open_report_continuity_across_claimed_m5_test_surfaces;
pub mod implement_failure_triage_panels_quarantine_review_sheets_and_environment_matrix_cards_with_assertion_diff_summaries_recent_attempts_env_build_runtime_deltas_owner_expiry_release_impact_and_rerun_debug_review_parity_across_claimed_m5_quality_surfaces;
pub mod implement_flaky_state_badges_and_retry_history_rows_with_controlled_verdict_vocabulary_classifier_confidence_retry_window_visibility_environment_drift_notes_and_rerun_or_open_logs_parity_across_claimed_m5_quality_surfaces;
pub mod implement_inline_result_markers_with_live_versus_imported_versus_stale_stability_chips_open_recent_attempts_and_target_env_shorthand_across_claimed_m5_editors_and_notebook_views;
pub mod implement_keyboard_screen_reader_cli_export_parity_and_automatic_narrowing_when_included_run_provenance_branch_coverage_flaky_windows_baseline_identity_or_sandbox_validation_is_partial_or_stale_across_claimed_m5_test_intelligence_components;
pub mod implement_keyboard_screen_reader_cli_export_parity_and_automatic_narrowing_when_result_evidence_is_imported_or_stale_watch_fidelity_is_reduced_selection_widens_or_quarantine_state_is_expired_or_policy_blocked_across_claimed_m5_test_components;
pub mod implement_keyboard_screen_reader_cli_export_parity_and_execution_lifecycle_auto_narrowing;
pub mod implement_session_summary_bars_and_watch_mode_banners_with_exact_selection_running_backlog_retry_counts_live_reduced_polling_unavailable_state_last_successful_cycle_and_recover_pause_truth_across_claimed_m5_test_lanes;
pub mod implement_snapshot_or_golden_review_cards_and_coverage_import_merge_sheets_with_artifact_baseline_identity_raw_or_text_fallback_shard_inclusion_truth_and_stale_or_incompatible_warnings_across_claimed_m5_review_surfaces;
pub mod implement_test_generation_suggestion_cards_with_uncovered_path_or_bug_trigger_truth_assumption_summaries_helper_fixture_snapshot_separation_sandbox_validation_and_diff_first_apply_parity_across_claimed_m5_ai_test_flows;
pub mod implement_test_tree_rows_with_suite_template_case_notebook_imported_result_distinction_parameterized_counts_freshness_target_chip_and_mute_quarantine_truth_across_claimed_m5_test_surfaces;
...
pub use capsule_resolver::beta::{
    ...
    CapsuleBetaSourceParse, CapsuleBetaSourceReadState, CapsuleBetaSupportAbsenceSummary,
    CapsuleBetaSupportCoverageProjection, CapsuleBetaSupportCoverageRow,
    CapsuleBetaSupportDetectorSummary, CapsuleBetaSupportDigest,
    CapsuleBetaSupportDigestProjectionClass, CapsuleBetaSupportDriftEvaluationProjection,
    CapsuleBetaSupportDriftRowProjection, CapsuleBetaSupportFieldDisposition,
    CapsuleBetaSupportFieldDispositionClass, CapsuleBetaSupportParsedSummary,
    CapsuleBetaSupportResolutionProjection, CapsuleBetaSupportSourceProjection,
    ComposeParsedFields, DevcontainerParsedFields, EnvironmentCapsuleBetaCoverageManifest,
    ...
    ENVIRONMENT_CAPSULE_BETA_SUPPORT_REDACTION_PROFILE_REF,
};
