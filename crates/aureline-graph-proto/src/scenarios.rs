...
fn local_root_workspace() -> Scenario {
    let nodes = vec![
        GraphNode {
            ...
            display_label: Some("Current root".into()),
            provenance_stamp: authoritative_stamp(
                1,
                1,
                SourceClass::WorkspaceFilesystem,
                "workspace_authority",
            ),
        ...
        GraphNode {
            ...
            provenance_stamp: authoritative_stamp(
                1,
                4,
                SourceClass::SymbolResolver,
                "symbol_resolver.rust",
            ),
        ...
        GraphNode {
            ...
            provenance_stamp: authoritative_stamp(
                1,
                6,
                SourceClass::CodeownersResolver,
                "codeowners_resolver",
            ),
            ...
            confidence_rollup: None,
            query_family_tags: vec![
                QueryFamilyTag::OwnershipLookup,
                QueryFamilyTag::ReviewImpactWalk,
            ],
            shard_affinity_tags: vec![ShardAffinityTag::WorkspaceRootLocal],
    ...
    let edges = vec![
        ...
        GraphEdge {
            ...
            query_family_tags: vec![
                QueryFamilyTag::DocsSearch,
                QueryFamilyTag::CitedExplainerWalk,
            ],
    ...
    let nodes = vec![
        ...
        GraphNode {
            ...
            provenance_stamp: authoritative_stamp(
                2,
                2,
                SourceClass::BuildToolchain,
                "build_toolchain.cargo",
            ),
    ...
    let nodes = vec![
        GraphNode {
            ...
            provenance_stamp: authoritative_stamp(
                3,
                1,
                SourceClass::ConnectedProvider,
                "connected_provider.code_host",
            ),
            ...
            query_family_tags: vec![
                QueryFamilyTag::TopologyWalk,
                QueryFamilyTag::ProviderResourceLookup,
            ],
        ...
        GraphNode {
            ...
            provenance_stamp: authoritative_stamp(
                ...
                3,
                SourceClass::ConnectedProvider,
                "connected_provider.issue_tracker",
            ),
        ...
        GraphNode {
            ...
            node_body: NodeBody::File {
                filesystem_identity: FilesystemIdentity {
                    ...
                    logical_workspace_identity: "ws:aureline/root:0/crates/editor_core/src/lib.rs"
                        .into(),
