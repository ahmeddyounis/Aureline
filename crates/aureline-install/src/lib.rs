...
pub use freeze_the_m5_deployment_continuity_component_matrix::{
    current_m5_deployment_continuity_component_matrix_export,
    current_m5_deployment_continuity_surface_certification_export,
    seeded_deployment_continuity_component_matrix,
    seeded_deployment_continuity_surface_certification, ChannelAssociationReviewRowDescriptor,
    ComponentRow, ControlPlaneDataPlaneStatusStripDescriptor, DegradedState,
    DeploymentContinuityComponentArtifactError, DeploymentContinuityComponentMatrix,
    DeploymentContinuityComponentMatrixInput, DeploymentContinuityComponentViolation,
    DeploymentContinuityConsumerProjection, DeploymentContinuityGuardrails,
    DeploymentSummaryCardDescriptor, InstallProfileCardDescriptor, M5BoundaryChangeClass,
    M5ClaimedDeploymentSurface, M5DeploymentCertificationDrillKind, M5DeploymentClaimLabel,
    M5DeploymentCompatibilityDimension, M5DeploymentCompatibilityPosture,
    M5DeploymentComponentFamily, M5DeploymentContinuityCompatibilityNote,
    M5DeploymentContinuityDrillResult, M5DeploymentContinuityReleaseSupportProof,
    ...
    M5DeploymentContinuitySurfaceCertificationViolation, M5DeploymentDowngradeTrigger,
    M5DeploymentDrillOutcome, M5DeploymentMode, M5DeploymentRequiredLabel, M5DeploymentTruthMode,
    M5MirrorSignatureState, M5PlaneState, M5PromotionState, M5ResidualDependencyClass,
    M5RolloutRing, MirrorOfflineArtifactRowDescriptor, ModeChangeReviewSheetDescriptor,
    ResidualDependencyRowDescriptor, RolloutRingRowDescriptor, SideBySideImportSheetDescriptor,
    DEPLOYMENT_CONTINUITY_COMPONENT_CERTIFICATION_ARTIFACT_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_CERTIFICATION_CSV_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_CERTIFICATION_REPORT_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_ARTIFACT_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_DOC_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_FIXTURE_DIR,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_RECORD_KIND,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_SCHEMA_REF,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_SCHEMA_VERSION,
    DEPLOYMENT_CONTINUITY_COMPONENT_MATRIX_SUMMARY_REF,
    M5_DEPLOYMENT_CONTINUITY_SURFACE_CERTIFICATION_RECORD_KIND,
    M5_DEPLOYMENT_CONTINUITY_SURFACE_CERTIFICATION_SCHEMA_VERSION,
};
...
pub use rollback::{
    ...
    UpdateRollbackValidationFinding, UpdateRollbackValidationReport, ROLLBACK_DRILL_MAX_DEPTH,
    ROLLBACK_DRILL_MAX_DIRECTORY_ENTRIES, ROLLBACK_DRILL_MAX_ENTRIES,
    ROLLBACK_DRILL_MAX_EXPECTED_DELTAS, ROLLBACK_DRILL_MAX_FILE_BYTES,
    ROLLBACK_DRILL_MAX_RELATIVE_PATH_BYTES, ROLLBACK_DRILL_MAX_ROOTS,
    ROLLBACK_DRILL_MAX_SNAPSHOT_BYTES, ROLLBACK_DRILL_MAX_TOTAL_FILE_BYTES,
...
pub use implement_the_m5_handler_ownership_disclosure_and_channel_association_review_primitive::{
    ...
    M5HandlerOwnershipArtifactError, M5HandlerOwnershipCase, M5HandlerOwnershipConsumerProjection,
    M5HandlerOwnershipExportField, M5HandlerOwnershipGovernanceReview, M5HandlerOwnershipInput,
...
pub use implement_the_m5_mirror_offline_mode_change_and_channel_association_primitive::{
    ...
    M5MirrorArtifactClass, M5MirrorArtifactInput, M5MirrorContinuityState, M5MirrorSourceClass,
    M5MirrorSurfaceFamily, M5MirrorTransitionArtifactError, M5MirrorTransitionCase,
    M5MirrorTransitionConsumerProjection, M5MirrorTransitionExportField,
    M5MirrorTransitionGovernanceReview, M5MirrorTransitionInput, M5MirrorTransitionPrimitivePacket,
    M5MirrorTransitionPrimitivePacketInput, M5MirrorTransitionReleasePosture,
    M5MirrorTransitionResolutionError, M5MirrorTransitionSurfaceRow, M5MirrorTransitionViolation,
    M5MirrorTransitionVocabularySet, M5ResolvedChannelAssociationRow, M5ResolvedMirrorArtifactRow,
    M5ResolvedMirrorTransition, M5ResolvedModeChangeReviewSheet, M5RollbackPathState,
    M5_MIRROR_TRANSITION_ARTIFACT_REF, M5_MIRROR_TRANSITION_COMPONENT_MATRIX_REF,
    M5_MIRROR_TRANSITION_CSV_REF, M5_MIRROR_TRANSITION_DOC_REF, M5_MIRROR_TRANSITION_FIXTURE_DIR,
