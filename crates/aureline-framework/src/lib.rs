...
pub use status_and_certainty::{
    ...
    FrameworkObjectCertainty, FrameworkObjectKind, FrameworkObjectRowBlock,
    FrameworkObjectRowKind, FrameworkSupportActionClass, FrameworkSupportStrip,
    GeneratorFileEffectRow, GeneratorKindClass, GeneratorPreviewBlock, HealthBlock, HealthClass,
    LocalityClass, PackOrBridgeSourceBlock, PackSourceClass, RollbackClass, RowActionClass,
    ScopeBlock, SupportClass, SurfaceClass, VersionCompatibilityClass,
    ...
    FRAMEWORK_SUPPORT_STRIP_RECORD_KIND, FRAMEWORK_SUPPORT_STRIP_SCHEMA_VERSION, FreshnessClass,
};
