//! Conformance dump for the M5 visual-designer component matrix packet.
//!
...
use aureline_preview::seeded_visual_designer_component_matrix;

fn main() {
    let which = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "support".to_owned());
    let packet = seeded_visual_designer_component_matrix();
