//! Conformance dump for the M5 visual-designer component accessibility fallback
//! packet.
//!
...
use aureline_preview::seeded_m5_visual_designer_a11y_fallback_packet;

fn main() {
    let which = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "support".to_owned());
    let packet = seeded_m5_visual_designer_a11y_fallback_packet();
