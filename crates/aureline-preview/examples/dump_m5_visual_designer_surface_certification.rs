//! Conformance dump for the M5 visual-designer surface-certification packet.
//!
...
use aureline_preview::seeded_m5_visual_designer_surface_certification_packet;

fn main() {
    let which = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "support".to_owned());
    let packet = seeded_m5_visual_designer_surface_certification_packet();
