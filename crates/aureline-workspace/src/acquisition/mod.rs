...
pub use descriptors::{
    ...
    ArtifactDescriptor, ArtifactSignatureState, AttachAuthorityClass, AttributableEvidence,
    AttributableEvidenceClass, AuthModeClass, BlockedExecutionPathClass, BlockerClass,
    ...
    DeepLinkClass, DeepLinkDescriptor, DiscardPosture, HostEndpointDescriptor, LiveSessionClass,
    LiveSessionDescriptor, LocatorArtifactClass, LocatorClass, LocatorEntryVerbHint,
    LocatorTargetKindHint, MirrorFreshnessClass, MirrorFreshnessEvidence, NextStepDecisionHook,
    PolicyNarrowingRef, PolicySourceClass, ReadOnlyPartialRoot, ReadOnlyPartialRootClass,
    RepairHookClass, ResumableAcquisitionState, SetupActionsClass, SideEffectBypassPath,
    SideEffectCleanupClass, SideEffectConnectivityClass, SideEffectEnvelope, SideEffectTimeClass,
    SignerContinuityClass, SignerContinuityEvidence, SkipReasonClass, SourceLocatorRecord,
    SourceLocatorRecordKind, TopologyMarker, TopologyMarkerClass, TransportClass,
    UpstreamDeltaClass, BOOTSTRAP_QUEUE_ITEM_RECORD_KIND, BOOTSTRAP_QUEUE_ITEM_SCHEMA_VERSION,
