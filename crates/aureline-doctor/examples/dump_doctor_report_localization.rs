//! Emits the seeded Doctor report localization posture packet and projections.
//!
//! ```sh
...
//! cargo run -q -p aureline-doctor --example dump_doctor_report_localization -- parity
//! cargo run -q -p aureline-doctor --example dump_doctor_report_localization -- render ja-JP
//! ```

use aureline_doctor::seeded_doctor_report_localization_packet;
