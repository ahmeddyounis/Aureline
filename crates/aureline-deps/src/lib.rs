...
pub mod certify_package_management_component_truth_on_every_claimed_m5_package_management_surface;
...
pub mod implement_keyboard_screen_reader_cli_export_parity_and_automatic_narrowing_when_manifest_scope_registry_freshness_auth_state_or_lockfile_impact_truth_is_stale_or_partial_across_claimed_m5_package_components;
...
pub use implement_script_risk_notices_grouped_update_planners_and_rollback_checkpoint_strips::{
    ...
    SCRIPT_RISK_GROUPED_UPDATE_ROLLBACK_FIXTURE_DIR,
    SCRIPT_RISK_GROUPED_UPDATE_ROLLBACK_RECORD_KIND,
