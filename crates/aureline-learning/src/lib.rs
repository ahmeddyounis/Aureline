...
pub mod add_shared_onboarding_migration_contextual_help_docs_browser_feature_family_tour_companion_handoff_and_support_export_consumers_so_learning_components_keep_citation_privacy_and_progress_language_aligned_across_claimed_m5_profiles;
pub mod certify_contextual_tip_card_migration_bridge_card_sequence_help_strip_why_unavailable_explanation_row_and_source_language_fallback_truth_on_every_claimed_m5_onboarding_migration_and_command_help_surface;
...
pub mod freeze_the_m5_learning_mode_toggle_tip_card_guided_exercise_step_glossary_chip_or_card_safe_explanation_banner_and_progress_marker_component_matrix;
...
pub mod implement_glossary_chips_or_cards_and_safe_explanation_banners_with_cited_file_symbol_doc_truth_freshness_source_class_labels_and_explain_versus_do_separation_across_claimed_m5_learning_surfaces;
pub mod implement_guided_exercise_steps_and_progress_markers_with_target_object_success_criteria_hint_reveal_reset_skip_sandbox_or_preview_preference_and_privacy_bounded_resume_export_truth_across_claimed_m5_learnability_lanes;
...
pub mod implement_keyboard_screen_reader_localization_export_parity_and_automatic_narrowing_when_citations_are_stale_pack_freshness_drifted_progress_portability_is_blocked_or_explain_do_boundaries_cannot_be_proven_across_claimed_m5_learning_components;
pub mod implement_learning_mode_toggles_and_tip_cards_with_user_workspace_scope_pause_snooze_reset_why_now_context_and_stable_command_file_docs_deep_link_truth_across_claimed_m5_onboarding_and_help_surfaces;
...
pub mod ship_educational_ai_boundaries_no_hidden_apply_safeguards_and_offline_local_only_or_cached_pack_continuity_across_claimed_m5_guided_teaching_flows;
