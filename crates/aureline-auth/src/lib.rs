...
pub use m5_secret_boundary_depth::{
    ...
    seeded_secret_boundary_profile_parity_rows, seeded_secret_boundary_surface_row,
    validate_m5_secret_boundary_depth_packet,
    ...
    secret_boundary_use_audit_result_for_health,
