...
pub use m5_secret_boundary_depth::{
    ...
    SecretBoundaryFailureDimensionClass, SecretBoundaryLineageBundle,
    SecretBoundaryLineageEvent, SecretBoundaryLineageEventClass,
    SecretBoundaryLastKnownGoodClass, SecretBoundaryProfileParityRow,
    SecretBoundaryProfileQualificationRow, SecretBoundaryProofFreshnessClass,
    ...
    SecretBoundaryQualificationLabel, SecretBoundaryQualificationNarrowReason,
    SecretBoundaryQualificationProof,
    SecretBoundaryProjectionParityClass, SecretBoundaryRepairOwnerClass,
    SecretBoundaryRepairableChangeClass, SecretBoundaryRepairableState,
    ...
    SecretBoundarySecretAccessPrompt, SecretBoundarySecretClass, SecretBoundaryStorageClass,
    SecretBoundarySummary, SecretBoundarySupportExport, SecretBoundarySupportExportRow,
    SecretBoundaryOmittedMaterialClass,
    SecretBoundarySurfaceDomain, SecretBoundarySurfaceRow, SecretBoundarySurfaceState,
    SecretBoundaryWorkflowHistoryRow,
    SecretBoundaryTrustStoreDependencyClass, SecretBoundaryUseAuditResultClass,
