//! Conformance dump for the commercial-boundary-card set.
//!
//! Prints the canonical card set so the checked-in artifact and fixtures can be
...
use aureline_service::m5_commercial_boundary_cards::*;
...
fn main() {
    ...
    let set = match which.as_str() {
        "canonical" => canonical_stable_commercial_boundary_card_set(),
        other => {
