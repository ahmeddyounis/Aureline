...
//! The [`export_delete_lifecycle`] module promotes export jobs, request cases,
//! delete cases, manifests, and receipts into one canonical truth source for
//! M5 managed/provider-support surfaces.
