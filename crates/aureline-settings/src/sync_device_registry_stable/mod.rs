...
pub use model::{
    ...
    DeviceParticipationState, EntryRouteRecord, IdentityModeClass, LayoutMode,
    LayoutModeDisclosure, LifecycleMarker, MergeClass, ProfileDurabilityClass,
    ProfileRoamingSummary, RecoveryActionRole, RecoveryRouteRecord, RouteSurface,
    SecretBoundaryRow, SettingCategory, SnapshotClass, SnapshotRow, StableClaimClass, StateClass,
    SurfaceClass, SurfaceParityRow, SyncDeviceRegistryCertification, SYNC_DEVICE_REGISTRY_NOTICE,
    SYNC_DEVICE_REGISTRY_RECORD_KIND, SYNC_DEVICE_REGISTRY_SCHEMA_VERSION,
