...
pub mod add_docs_help_marketplace_account_embedded_webview_auth_handoff_and_remote_service_dashboard_consumers_so_embedded_boundary_components_keep_owner_origin_data_boundary_and_browser_fallback_language_aligned;
...
pub mod add_shell_status_activity_center_notebook_preview_docs_browser_pipeline_incident_and_support_export_consumers_so_adaptive_efficiency_components_keep_source_state_backlog_and_stale_result_language_aligned;
pub mod admin_alpha;
...
pub mod content;
pub mod content_design_certification;
...
pub mod freeze_the_m5_docs_pane_header_embedded_origin_bar_boundary_fact_grid_marketplace_account_boundary_card_auth_handoff_card_remote_service_dashboard_header_open_in_browser_handoff_row_and_embedded_state_panel_component_matrix;
pub mod freeze_the_m5_keyboard_mode_modal_sequence_clipboard_route_drag_drop_verb_and_grouped_history_matrix;
pub mod freeze_the_m5_lifecycle_state_and_journey_checkpoint_matrix;
pub mod freeze_the_m5_menu_keybinding_resolver_and_command_documentation_matrix;
pub mod freeze_the_m5_power_state_indicator_throttled_subsystem_row_background_work_row_background_work_banner_per_workspace_override_sheet_override_policy_note_row_resume_summary_card_and_stale_result_continuity_note_component_matrix;
pub mod freeze_the_m5_presentation_session_walkthrough_waypoint_speaker_note_and_audience_follow_matrix;
pub mod freeze_the_m5_public_handoff_and_capture_boundary_matrix;
pub mod freeze_the_m5_security_advisory_emergency_notice_affected_install_and_disclosure_link_matrix;
pub mod freeze_the_m5_settings_row_capability_sheet_evidence_chronology_and_chronology_export_component_matrix;
pub mod freeze_the_m5_shell_zone_responsive_class_and_multi_window_continuity_matrix;
pub mod freeze_the_m5_status_bar_transient_inspect_pane_control_and_durable_progress_component_matrix;
pub mod freeze_the_m5_terminal_tab_remote_target_pill_environment_status_strip_toolchain_pin_row_presence_avatar_stack_and_repair_action_card_component_matrix;
...
pub mod implement_keyboard_screen_reader_cli_export_parity_and_runtime_boundary_claim_auto_narrowing;
pub mod implement_keyboard_screen_reader_reduced_motion_high_contrast_cli_export_and_support_packet_parity_and_adaptive_efficiency_component_claim_auto_narrowing;
pub mod implement_keyboard_screen_reader_reduced_motion_high_contrast_cli_export_and_support_packet_parity_and_embedded_boundary_component_claim_auto_narrowing;
pub mod implement_multi_cursor_fold_state_breadcrumb_minimap_overview_ruler_and_degraded_orientati;
pub mod implement_the_m5_advisory_card_and_row_primitive;
pub mod implement_the_m5_affected_install_assessment_panel_primitive;
pub mod implement_the_m5_auth_handoff_card_and_remote_service_dashboard_header_provider_domain_reason_fallback_local_continuity_device_code_expiry_target_service_identity_freshness_export_open_console_and_no_embedded_high_risk_approval_primitive;
pub mod implement_the_m5_background_work_row_and_background_work_banner_affected_work_class_state_what_still_works_resume_condition_and_override_primitive;
pub mod implement_the_m5_capability_sheet_consequence_grouping_transitive_scope_and_reconsent_primitive;
pub mod implement_the_m5_chronology_group_narrative_card_and_export_preview_primitive;
pub mod implement_the_m5_disclosure_and_history_block_primitive;
pub mod implement_the_m5_docs_pane_header_and_boundary_fact_grid_source_class_version_owner_origin_open_externally_and_data_boundary_primitive;
pub mod implement_the_m5_embedded_origin_bar_and_embedded_state_panel_extension_publisher_origin_permission_capability_reload_open_in_browser_and_offline_stale_policy_blocked_cross_origin_state_primitive;
pub mod implement_the_m5_emergency_notice_banner_primitive;
pub mod implement_the_m5_evidence_and_activity_timeline_row_primitive;
pub mod implement_the_m5_host_rendered_trust_component_primitives_and_token_state_wiring;
pub mod implement_the_m5_marketplace_account_boundary_card_and_open_in_browser_handoff_row_origin_account_scope_profile_region_tenant_network_state_browser_fallback_and_local_safe_continuity_primitive;
pub mod implement_the_m5_notification_and_activity_center_handoff_routing_primitive;
pub mod implement_the_m5_per_workspace_override_sheet_and_override_policy_note_row_current_mode_ceilings_expected_effect_reset_path_and_blocked_by_policy_primitive;
pub mod implement_the_m5_power_state_indicator_and_throttled_subsystem_row_source_active_state_affected_subsystem_and_inspect_path_primitive;
pub mod implement_the_m5_presence_avatar_stack_and_role_or_follow_badge_recording_state_and_local_fallback_continuity_primitive;
pub mod implement_the_m5_remote_target_pill_and_environment_status_strip_runtime_source_readiness_and_context_entrypoint_primitive;
pub mod implement_the_m5_repair_action_card_and_repair_preview_row_impact_scope_target_boundary_and_reversal_class_primitive;
pub mod implement_the_m5_resume_summary_card_and_stale_result_continuity_note_resumed_work_backlog_state_stale_results_visible_and_next_safe_action_primitive;
pub mod implement_the_m5_settings_row_effective_value_source_pill_and_lock_state_primitive;
pub mod implement_the_m5_terminal_tab_and_header_strip_boundary_liveness_and_shared_control_primitive;
pub mod implement_the_m5_toolchain_pin_row_precedence_inspector_and_switch_review_card_winning_scope_shadowed_layer_and_revert_or_repair_primitive;
pub mod import;
pub mod inspectors;
...
pub mod m5_advisory_component_release_proof;
...
pub mod m5_keybinding_resolver_inspectors;
pub mod m5_lifecycle_object_certification;
pub mod m5_lifecycle_release_proof;
pub mod m5_lifecycle_telemetry_conformance;
...
pub mod m5_project_entry_component_certification;
