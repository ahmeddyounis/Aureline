//! Canonical seed builders for the M5 line-constrained_state_descriptor and line-downgrade-packet registries packet.
//!
//! These builders are the single producer of the checked-in support export and the narrowed fixtures.
//! The headless emitter and the inline tests both call them so the in-code registries, the artifact, and the
//! fixtures never drift. Every resolved example is built by calling the real resolvers so the packet can only
//! carry projections the resolvers actually produce. Clean line-constrained_state_descriptor and line-downgrade-packet entries
//! are built so the one typed line-constrained_state_descriptor object resolving per line, lines never widening without
...
pub const M5_CONSTRAINED_STATE_DESCRIPTOR_CHANGE_DIFF_REGISTRIES_PACKET_ID: &str =
    "m5-constrained-state-descriptor-and-change-diff-registries:stable:0001";
...
fn constrained_state_descriptor(
    input: M5ConstrainedStateDescriptorEntryResolutionInput,
) -> M5ResolvedConstrainedStateDescriptorEntry {
    resolve_constrained_state_descriptor_entry(input)
        .expect("seed line-constrained_state_descriptor entry resolves")
}
...
fn all_forms() -> Vec<M5ConstrainedStateDescriptorResolutionForm> {
    M5ConstrainedStateDescriptorResolutionForm::ALL.to_vec()
}

// -- Clean line-constrained_state_descriptor entries (typed object, rollback / diagnostics preserved, bound to the registry) --

#[allow(clippy::too_many_arguments)]
fn clean_constrained_state_descriptor_base(
    entry_id: &str,
    line_binding_id: &str,
    token_name: &str,
    semantic_role: M5ConstrainedFileStateRole,
    report_section: M5ConstrainedStateDescriptorKind,
    surface_context: M5ConstrainedStateDescriptorSurfaceContext,
...
fn constrained_state_descriptor_read_only_path_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    constrained_state_descriptor(clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:shiproom:dogfood-core-team-canary",
        "launch.line.core-team-canary",
        "line.constrained_state_descriptor.core_team_canary",
        M5ConstrainedFileStateRole::StateBadgeClassification,
        M5ConstrainedStateDescriptorKind::ReadOnlyPathObject,
        M5ConstrainedStateDescriptorSurfaceContext::ShiproomSurface,
...
fn constrained_state_descriptor_generated_artifact_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    constrained_state_descriptor(clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:release-center:migration-alpha",
        "launch.line.migration-alpha",
        "line.constrained_state_descriptor.generated_artifact_object",
        M5ConstrainedFileStateRole::BlockedWriteReason,
        M5ConstrainedStateDescriptorKind::GeneratedArtifactObject,
        M5ConstrainedStateDescriptorSurfaceContext::ReleaseCenterSurface,
...
fn constrained_state_descriptor_policy_locked_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    constrained_state_descriptor(clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:program-governance:extension-author",
        "launch.line.extension-author",
        "line.constrained_state_descriptor.policy_locked_object",
        M5ConstrainedFileStateRole::CanonicalSourceRelation,
        M5ConstrainedStateDescriptorKind::PolicyLockedObject,
        M5ConstrainedStateDescriptorSurfaceContext::ProgramGovernanceSurface,
...
fn constrained_state_descriptor_managed_mirrored_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    // A design-partner preview line is public-facing and keeps its support language matched to line proof.
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:executive-steering:design-partner-preview",
        "launch.line.design-partner-preview",
        "line.constrained_state_descriptor.managed_mirrored_object",
        M5ConstrainedFileStateRole::StateBadgeClassification,
        M5ConstrainedStateDescriptorKind::ManagedMirroredObject,
        M5ConstrainedStateDescriptorSurfaceContext::ExecutiveSteeringSurface,
    ...
    constrained_state_descriptor(base)
}

fn constrained_state_descriptor_projection_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    // A public preview line is public-facing and keeps its support language matched to line proof.
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:support:public-preview",
        "launch.line.public-preview",
        "line.constrained_state_descriptor.projection_object",
        M5ConstrainedFileStateRole::BlockedWriteReason,
        M5ConstrainedStateDescriptorKind::ProjectionObject,
        M5ConstrainedStateDescriptorSurfaceContext::SupportOrExportForm,
...
fn constrained_state_descriptor_captured_snapshot_object_clean(
) -> M5ResolvedConstrainedStateDescriptorEntry {
    constrained_state_descriptor(clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:release-center:certified-journey",
        "launch.line.certified-journey",
        "line.constrained_state_descriptor.captured_snapshot_object",
        M5ConstrainedFileStateRole::ExactWriteTarget,
        M5ConstrainedStateDescriptorKind::CapturedSnapshotObject,
        M5ConstrainedStateDescriptorSurfaceContext::ReleaseCenterSurface,
...
// -- Degraded line-constrained_state_descriptor entries ---------------------------------------------------------

/// Degraded constrained_state_descriptor entry: the resolved constrained_state_descriptor object is incomplete — the bundle IDs are unstated.
fn constrained_state_descriptor_object_incomplete() -> M5ResolvedConstrainedStateDescriptorEntry {
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:shiproom:incomplete",
        "launch.line.core-team-canary",
        "line.constrained_state_descriptor.core_team_canary",
        M5ConstrainedFileStateRole::StateBadgeClassification,
        M5ConstrainedStateDescriptorKind::ReadOnlyPathObject,
...
/// Degraded constrained_state_descriptor entry: the line's rollback and diagnostics posture is not preserved before widening —
...
fn constrained_state_descriptor_widen_fold() -> M5ResolvedConstrainedStateDescriptorEntry {
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:release-center:widen-fold",
        "launch.line.migration-alpha",
        "line.constrained_state_descriptor.generated_artifact_object",
        M5ConstrainedFileStateRole::BlockedWriteReason,
        M5ConstrainedStateDescriptorKind::GeneratedArtifactObject,
...
/// Degraded constrained_state_descriptor entry: the behavior is a hand-copied per-entry assumption instead of tracing to the
/// registry.
fn constrained_state_descriptor_unbound() -> M5ResolvedConstrainedStateDescriptorEntry {
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:executive-steering:unbound",
        "launch.line.certified-journey",
        "line.constrained_state_descriptor.captured_snapshot_object",
        M5ConstrainedFileStateRole::ExactWriteTarget,
        M5ConstrainedStateDescriptorKind::CapturedSnapshotObject,
...
/// Degraded constrained_state_descriptor entry: the canonical registry token name is unstated.
fn constrained_state_descriptor_token_unstated() -> M5ResolvedConstrainedStateDescriptorEntry {
    let mut base = clean_constrained_state_descriptor_base(
        "constrained_state_descriptor:program-governance:token-unstated",
        "launch.line.extension-author",
        "  ",
        M5ConstrainedFileStateRole::CanonicalSourceRelation,
        M5ConstrainedStateDescriptorKind::PolicyLockedObject,
...
fn downgrade_dogfood_ring_clean() -> M5ResolvedDescriptorChangeDiffEntry {
    ...
    let mut base = clean_downgrade_base(
        ...
        M5ConstrainedFileStateRole::StateBadgeClassification,
        M5DescriptorChangeDiffScope::StateClassChange,
        M5ConstrainedStateDescriptorSurfaceContext::ShiproomSurface,
...
fn downgrade_rehearsal_currency_clean() -> M5ResolvedDescriptorChangeDiffEntry {
    downgrade(clean_downgrade_base(
        ...
        M5ConstrainedFileStateRole::CanonicalSourceRelation,
        M5DescriptorChangeDiffScope::CanonicalSourceChange,
        M5ConstrainedStateDescriptorSurfaceContext::ProgramGovernanceSurface,
...
fn downgrade_go_no_go_signoff_clean() -> M5ResolvedDescriptorChangeDiffEntry {
    downgrade(clean_downgrade_base(
        ...
        M5ConstrainedFileStateRole::ExactWriteTarget,
        M5DescriptorChangeDiffScope::WriteTargetChange,
        M5ConstrainedStateDescriptorSurfaceContext::ReleaseCenterSurface,
...
#[allow(clippy::too_many_arguments)]
fn base_row(
    consumer_surface: M5ConstrainedStateDescriptorChangeDiffRegistriesConsumerSurface,
    owner_role: &str,
    scope_summary: &str,
    proof_ref: &str,
    downgrade_triggers: Vec<M5ConstrainedFileStateDowngradeTrigger>,
    constrained_state_descriptor_entries: Vec<M5ResolvedConstrainedStateDescriptorEntry>,
    descriptor_change_diff_entries: Vec<M5ResolvedDescriptorChangeDiffEntry>,
) -> M5ConstrainedStateDescriptorChangeDiffRegistriesRow {
    M5ConstrainedStateDescriptorChangeDiffRegistriesRow {
        consumer_surface,
        ...
        anatomy_parts: M5ConstrainedStateDescriptorAnatomyPart::ALL.to_vec(),
        export_fields: M5ConstrainedStateDescriptorExportField::ALL.to_vec(),
        downgrade_triggers,
...
fn registry_rows() -> Vec<M5ConstrainedStateDescriptorChangeDiffRegistriesRow> {
    ...
    vec![
        base_row(
            ...
            vec![
                constrained_state_descriptor_read_only_path_object_clean(),
                constrained_state_descriptor_object_incomplete(),
            ],
        ...
        base_row(
            ...
            vec![constrained_state_descriptor_generated_artifact_object_clean(), constrained_state_descriptor_widen_fold()],
        ...
        base_row(
            ...
            vec![
                constrained_state_descriptor_managed_mirrored_object_clean(),
                constrained_state_descriptor_unbound(),
            ],
        ...
        base_row(
            ...
            vec![
                constrained_state_descriptor_policy_locked_object_clean(),
                constrained_state_descriptor_token_unstated(),
            ],
        ...
        base_row(
            ...
            "Install / update renders the same resolved constrained-state-descriptor and descriptor-change-diff truth the resolvers produced across the canonical, accessible, and audit resolution forms rather than a hand-copied class table; the export / rollback-route field and the disable-or-export-route-change diff stay inspectable off-renderer so no new install can still select a retired class",
        ...
        base_row(
            ...
            vec![constrained_state_descriptor_projection_object_clean()],
            vec![downgrade_rehearsal_currency_clean()],
        ),
    ]
}

fn governance_review() -> M5ConstrainedStateDescriptorChangeDiffRegistriesGovernanceReview {
    M5ConstrainedStateDescriptorChangeDiffRegistriesGovernanceReview {
        constrained_state_descriptor_registry_names_token_role_and_journey: true,
        line_resolves_to_typed_constrained_state_descriptor_from_shared_registry: true,
        ...
        constrained_state_descriptor_or_downgrade_drift_caught_before_release: true,
        every_row_declares_mandatory_anatomy: true,
        reuses_frozen_matrix_vocabulary: true,
    }
}

fn consumer_projection() -> M5ConstrainedStateDescriptorChangeDiffRegistriesConsumerProjection {
    M5ConstrainedStateDescriptorChangeDiffRegistriesConsumerProjection {
...
fn proof_freshness() -> M5ConstrainedStateDescriptorChangeDiffRegistriesProofFreshness {
    M5ConstrainedStateDescriptorChangeDiffRegistriesProofFreshness {
...
fn release_posture() -> M5ConstrainedStateDescriptorChangeDiffRegistriesReleasePosture {
    M5ConstrainedStateDescriptorChangeDiffRegistriesReleasePosture {
        proof_packet_ref: M5_CONSTRAINED_STATE_DESCRIPTOR_CHANGE_DIFF_REGISTRIES_ARTIFACT_REF
            .to_owned(),
        line_audit_ref: M5_CONSTRAINED_STATE_DESCRIPTOR_CHANGE_DIFF_REGISTRIES_REPORT_REF
            .to_owned(),
...
pub fn seeded_m5_constrained_state_descriptor_and_change_diff_registries_constrained_state_descriptor_beta_narrowed(
) -> M5ConstrainedStateDescriptorChangeDiffRegistriesPacket {
    let mut packet = seeded_m5_constrained_state_descriptor_and_change_diff_registries();
    packet.packet_id =
        "m5-constrained-state-descriptor-and-change-diff-registries:snapshot-descriptor-beta:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
...
pub fn seeded_m5_constrained_state_descriptor_and_change_diff_registries_descriptor_change_diff_preview_narrowed(
) -> M5ConstrainedStateDescriptorChangeDiffRegistriesPacket {
    let mut packet = seeded_m5_constrained_state_descriptor_and_change_diff_registries();
    packet.packet_id =
        "m5-constrained-state-descriptor-and-change-diff-registries:descriptor-change-diff-preview:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
