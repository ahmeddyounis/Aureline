...
fn clean_review_pack_record_input() -> M5AnchorHistoryRebindRecordEntryResolutionInput {
    M5AnchorHistoryRebindRecordEntryResolutionInput {
        ...
        report_section: M5AnchorHistoryRebindRecordKind::ChangedFilesScope,
        surface_context: M5AnchorHistoryRebindRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5AnchorHistoryRebindRecordResolutionForm::ALL.to_vec(),
...
fn clean_downgrade_input() -> M5AnchorHistoryRebindResultEntryResolutionInput {
    M5AnchorHistoryRebindResultEntryResolutionInput {
        ...
        semantic_role: M5CollaborationStateRole::AuthorityModelDisclosure,
        comparison_scope: M5AnchorHistoryRebindResultScope::EvaluatedScopeBinding,
        surface_context: M5AnchorHistoryRebindRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5AnchorHistoryRebindRecordResolutionForm::ALL.to_vec(),
...
fn review_pack_record_clean_names_meaning_and_is_bound() {
    ...
    assert_eq!(
        ...
        M5AnchorHistoryRebindRecordNextAction::ExpandCohortMeaning
    );
}
...
fn review_pack_record_unbound_and_unclassified_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5AnchorHistoryRebindRecordKind::PackScopeUnclassified;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_public_facing_and_surface_and_proof_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5AnchorHistoryRebindRecordKind::FullTreeScope;
    ...
    let mut input = clean_review_pack_record_input();
    input.surface_context = M5AnchorHistoryRebindRecordSurfaceContext::ContextUnknown;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_empty_id_and_forbidden_material_error() {
    ...
    assert_eq!(
        ...
        M5AnchorHistoryRebindRecordResolutionError::EmptyCohortDescriptorEntryId
    );
    ...
    assert_eq!(
        resolve_review_pack_record_entry(input).unwrap_err(),
        M5AnchorHistoryRebindRecordResolutionError::ForbiddenMaterial
    );
}
...
fn line_preserves_rollback_and_diagnostics_rejects_unpreserved() {
    ...
    assert!(!line_preserves_rollback_and_diagnostics_before_widening(
        M5AnchorHistoryRebindRecordKind::PackScopeUnclassified,
        true,
        false,
        true
    ));
...
fn downgrade_support_ahead_and_unclassified_degrade() {
    ...
    let mut input = clean_downgrade_input();
    input.comparison_scope = M5AnchorHistoryRebindResultScope::ChangeObjectResultUnclassified;
    assert_eq!(
...
fn downgrade_form_and_surface_and_id_and_material() {
    ...
    assert_eq!(
        ...
        M5AnchorHistoryRebindRecordResolutionError::EmptyCohortEvidencePacketEntryId
    );
...
fn vocabulary_set_drift_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5AnchorHistoryRebindRecordAndResultRegistriesViolation::VocabularySetDrift));
}
...
fn domain_schema_ref_missing_fails() {
    ...
    packet.registry_rows[0]
        ...
        .retain(|r| r != M5_SERVER_ORDERED_COMMENTS_ANNOTATIONS_REVIEW_PINS_DOMAIN_SCHEMA_REF);
    assert!(packet.validate().contains(
...
fn mandatory_anatomy_missing_fails() {
    ...
    packet.registry_rows[0]
        .anatomy_parts
        .retain(|p| *p != M5AnchorHistoryRebindRecordAnatomyPart::Identity);
    assert!(packet.validate().contains(
...
fn mandatory_export_field_missing_fails() {
    ...
    packet.registry_rows[0]
        .export_fields
        .retain(|f| *f != M5AnchorHistoryRebindRecordExportField::CohortArchetypes);
    assert!(packet.validate().contains(
...
fn examples_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5AnchorHistoryRebindRecordAndResultRegistriesViolation::ExamplesMissing));
}
...
fn dishonest_clean_example_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5AnchorHistoryRebindRecordAndResultRegistriesViolation::DishonestExample));
}
...
fn review_pack_record_not_proven_when_incomplete_example_removed() {
    ...
    for row in &mut packet.registry_rows {
        row.review_pack_record_entries.retain(|ex| {
            ex.degrade_reason
                != Some(
                    M5AnchorHistoryRebindRecordEntryDegradeReason::CohortDescriptorObjectIncomplete,
                )
        });
    }
    assert!(packet.validate().contains(
...
fn injected_raw_material_is_rejected() {
    ...
    assert!(packet
        .validate()
        .contains(&M5AnchorHistoryRebindRecordAndResultRegistriesViolation::RawMaterialInExport));
}
...
fn checked_support_export_validates_and_matches_seed() {
    let from_disk = current_stable_m5_comment_annotation_review_pin_anchor_history_and_rebind_review_registries_export()
        .expect(
...
fn checked_narrowed_fixtures_validate_and_match_seed_builders() {
    let beta: M5AnchorHistoryRebindRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/collaboration/m5-comment-annotation-review-pin-anchor-history-and-rebind-review-registries/anchor_history_beta_narrowed.json"
    )))
    ...
    let preview: M5AnchorHistoryRebindRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/collaboration/m5-comment-annotation-review-pin-anchor-history-and-rebind-review-registries/rebind_review_preview_narrowed.json"
    )))
