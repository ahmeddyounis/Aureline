...
pub mod m5_blocked_escalate_card_registries;
...
pub mod m5_change_intent_accessibility_parity_and_narrowing_when_linked_branch_review_provider_scope_publishability_or_reconcile_state_is_stale;
pub mod m5_change_intent_and_engineering_lifecycle_matrix;
pub mod m5_change_intent_lifecycle_registries;
pub mod m5_change_intent_record_and_start_work_registries;
pub mod m5_change_intent_shared_consumers_one_vocabulary_across_surfaces;
pub mod m5_change_intent_surface_certification;
pub mod m5_change_object_patch_stack_and_landing_matrix;
pub mod m5_change_object_record_and_selected_change_binding_registries;
pub mod m5_change_orchestration_accessibility_parity_and_narrowing_when_stack_membership_validation_queue_authority_protected_branch_or_orphan_cleanup_evidence_is_stale;
pub mod m5_change_orchestration_shared_consumers_one_vocabulary_across_surfaces;
pub mod m5_change_orchestration_surface_certification;
...
pub mod m5_collaboration_control_accessibility_parity_and_narrowing_when_control_authority_active_driver_presenter_handoff_consent_scope_retention_or_restore_replay_evidence_is_stale;
pub mod m5_collaboration_control_shared_consumers_one_vocabulary_across_surfaces;
pub mod m5_collaboration_control_surface_certification;
pub mod m5_collaboration_replica_descriptor_and_shared_object_record_registries;
pub mod m5_collaboration_replica_shared_object_authority_anchor_drift_convergence_and_session_archive_matrix;
pub mod m5_collaboration_state_headless_inspect_and_support_bundle_parity_registries;
pub mod m5_collaboration_state_surface_certification;
...
pub mod m5_comment_annotation_review_pin_anchor_history_and_rebind_review_registries;
...
pub mod m5_control_grant_and_presenter_handoff_sheet_registries;
...
pub mod m5_review_pack_accessibility_parity_and_narrowing_when_pack_version_digest_owner_provenance_parity_difference_or_template_attribution_is_stale;
...
pub mod m5_session_compaction_manifest_and_archive_finalization_registries;
pub mod m5_session_degradation_ladder_and_recovery_disposition_registries;
pub mod m5_session_policy_manifest_and_join_review_sheet_registries;
pub mod m5_session_provenance_freshness_and_consumer_truth_label_registries;
pub mod m5_session_restore_view_and_restore_grant_posture_registries;
...
pub mod m5_share_eligibility_and_downgrade_state_registries;
pub mod m5_shared_terminal_debug_control_grant_presenter_consent_retention_and_session_restore_view_matrix;
pub mod m5_shared_terminal_debug_view_and_control_channel_badge_registries;
...
pub mod m5_unsent_local_edit_preservation_and_recovery_disposition_registries;
