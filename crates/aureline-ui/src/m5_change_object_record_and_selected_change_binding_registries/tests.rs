...
fn clean_review_pack_record_input() -> M5ChangeObjectRecordEntryResolutionInput {
    M5ChangeObjectRecordEntryResolutionInput {
        ...
        report_section: M5ChangeObjectRecordKind::ChangedFilesScope,
        surface_context: M5ChangeObjectRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ChangeObjectRecordResolutionForm::ALL.to_vec(),
...
fn clean_downgrade_input() -> M5ChangeObjectResultEntryResolutionInput {
    M5ChangeObjectResultEntryResolutionInput {
        ...
        semantic_role: M5ChangeOrchestrationRole::SelectedChangeObjectDisclosure,
        comparison_scope: M5ChangeObjectResultScope::EvaluatedScopeBinding,
        surface_context: M5ChangeObjectRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ChangeObjectRecordResolutionForm::ALL.to_vec(),
...
fn seeded_registries_validates() {
    let packet = seeded_m5_change_object_record_and_selected_change_binding_registries();
...
fn review_pack_record_clean_names_meaning_and_is_bound() {
    ...
    assert_eq!(
        ...
        M5ChangeObjectRecordNextAction::ExpandCohortMeaning
    );
}
...
fn review_pack_record_unbound_and_unclassified_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ChangeObjectRecordKind::PackScopeUnclassified;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_object_incomplete_and_widen_fold_and_form_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.resolution_form_coverage = vec![M5ChangeObjectRecordResolutionForm::CanonicalObject];
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_public_facing_and_surface_and_proof_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ChangeObjectRecordKind::FullTreeScope;
    ...
    let mut input = clean_review_pack_record_input();
    input.surface_context = M5ChangeObjectRecordSurfaceContext::ContextUnknown;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_empty_id_and_forbidden_material_error() {
    ...
    assert_eq!(
        ...
        M5ChangeObjectRecordResolutionError::EmptyCohortDescriptorEntryId
    );
    ...
    assert_eq!(
        resolve_review_pack_record_entry(input).unwrap_err(),
        M5ChangeObjectRecordResolutionError::ForbiddenMaterial
    );
}
...
fn line_preserves_rollback_and_diagnostics_rejects_unpreserved() {
    ...
    assert!(!line_preserves_rollback_and_diagnostics_before_widening(
        M5ChangeObjectRecordKind::PackScopeUnclassified,
        true,
        false,
        true
    ));
...
fn downgrade_support_ahead_and_unclassified_degrade() {
    ...
    let mut input = clean_downgrade_input();
    input.comparison_scope = M5ChangeObjectResultScope::ChangeObjectResultUnclassified;
    assert_eq!(
...
fn downgrade_form_and_surface_and_id_and_material() {
    ...
    assert_eq!(
        ...
        M5ChangeObjectRecordResolutionError::EmptyCohortEvidencePacketEntryId
    );
...
fn vocabulary_set_drift_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::VocabularySetDrift));
}
...
fn missing_source_contracts_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::MissingSourceContracts));
}
...
fn domain_schema_ref_missing_fails() {
    ...
    packet.registry_rows[0]
        ...
        .retain(|r| r != M5_CHANGE_OBJECT_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::DomainSchemaRefMissing));

    let mut packet = seeded_m5_change_object_record_and_selected_change_binding_registries();
    packet.registry_rows[0]
        .source_contract_refs
        .retain(|r| r != M5_SELECTED_CHANGE_BINDING_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::DomainSchemaRefMissing));
}
...
fn mandatory_anatomy_missing_fails() {
    ...
    packet.registry_rows[0]
        .anatomy_parts
        .retain(|p| *p != M5ChangeObjectRecordAnatomyPart::Identity);
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::MandatoryAnatomyMissing));
}
...
fn mandatory_export_field_missing_fails() {
    ...
    packet.registry_rows[0]
        .export_fields
        .retain(|f| *f != M5ChangeObjectRecordExportField::CohortArchetypes);
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::MandatoryExportFieldMissing));
}
...
fn examples_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::ExamplesMissing));
}
...
fn dishonest_clean_example_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::DishonestExample));
}
...
fn row_invariant_violation_fails() {
    for mutate in 0u8..4 {
        ...
        assert!(packet
            .validate()
            .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::RowInvariantViolated));
    }
}
...
fn governance_review_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::GovernanceReviewIncomplete));
}
...
fn consumer_projection_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::ConsumerProjectionIncomplete));
}
...
fn proof_freshness_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::ProofFreshnessIncomplete));
}
...
fn release_posture_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::ReleasePostureIncomplete));
}
...
fn injected_raw_material_is_rejected() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeObjectRecordAndResultRegistriesViolation::RawMaterialInExport));
}

#[test]
fn export_carries_no_forbidden_raw_material() {
    let json =
        seeded_m5_change_object_record_and_selected_change_binding_registries().export_safe_json();
...
fn checked_support_export_validates_and_matches_seed() {
    let from_disk = current_stable_m5_change_object_record_and_selected_change_binding_registries_export()
        .expect(
...
fn checked_narrowed_fixtures_validate_and_match_seed_builders() {
    let beta: M5ChangeObjectRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-change-object-record-and-selected-change-binding-registries/change_object_record_beta_narrowed.json"
    )))
    ...
    let preview: M5ChangeObjectRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-change-object-record-and-selected-change-binding-registries/selected_change_binding_preview_narrowed.json"
    )))
