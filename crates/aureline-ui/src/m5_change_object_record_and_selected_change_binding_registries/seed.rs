...
pub const M5_CHANGE_OBJECT_RECORD_AND_RESULT_REGISTRIES_PACKET_ID: &str =
    "m5-change-object-record-and-selected-change-binding-registries:stable:0001";
...
) -> M5ResolvedChangeObjectRecordEntry {
    resolve_review_pack_record_entry(input).expect("seed line-review_pack_record entry resolves")
}

fn downgrade(input: M5ChangeObjectResultEntryResolutionInput) -> M5ResolvedChangeObjectResultEntry {
    resolve_review_pack_result_entry(input).expect("seed line-downgrade-packet entry resolves")
}

fn all_forms() -> Vec<M5ChangeObjectRecordResolutionForm> {
    M5ChangeObjectRecordResolutionForm::ALL.to_vec()
}
...
fn clean_review_pack_record_base(
    ...
    report_section: M5ChangeObjectRecordKind,
    surface_context: M5ChangeObjectRecordSurfaceContext,
...
) -> M5ChangeObjectRecordEntryResolutionInput {
    M5ChangeObjectRecordEntryResolutionInput {
...
fn review_pack_record_changed_files_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5ChangeObjectRecordKind::ChangedFilesScope,
        M5ChangeObjectRecordSurfaceContext::ShiproomSurface,
...
fn review_pack_record_pull_request_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5ChangeObjectRecordKind::PullRequestScope,
        M5ChangeObjectRecordSurfaceContext::ReleaseCenterSurface,
...
fn review_pack_record_base_head_range_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5ChangeObjectRecordKind::BaseHeadRangeScope,
        M5ChangeObjectRecordSurfaceContext::ProgramGovernanceSurface,
...
fn review_pack_record_worktree_uncommitted_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    ...
    let mut base = clean_review_pack_record_base(
        ...
        M5ChangeOrchestrationRole::SelectedChangeObjectDisclosure,
        M5ChangeObjectRecordKind::WorktreeUncommittedScope,
        M5ChangeObjectRecordSurfaceContext::ExecutiveSteeringSurface,
...
fn review_pack_record_full_tree_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    ...
    let mut base = clean_review_pack_record_base(
        ...
        M5ChangeOrchestrationRole::WorktreeBindingDisclosure,
        M5ChangeObjectRecordKind::FullTreeScope,
        M5ChangeObjectRecordSurfaceContext::SupportOrExportForm,
...
fn review_pack_record_saved_pack_snapshot_scope_clean() -> M5ResolvedChangeObjectRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5ChangeObjectRecordKind::SavedPackSnapshotScope,
        M5ChangeObjectRecordSurfaceContext::ReleaseCenterSurface,
...
fn review_pack_record_object_incomplete() -> M5ResolvedChangeObjectRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn review_pack_record_widen_fold() -> M5ResolvedChangeObjectRecordEntry {
    let mut base = clean_review_pack_record_base(
...
/// registry.
fn review_pack_record_unbound() -> M5ResolvedChangeObjectRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn review_pack_record_token_unstated() -> M5ResolvedChangeObjectRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn clean_downgrade_base(
    ...
    token_name: &str,
    semantic_role: M5ChangeOrchestrationRole,
    comparison_scope: M5ChangeObjectResultScope,
    surface_context: M5ChangeObjectRecordSurfaceContext,
...
) -> M5ChangeObjectResultEntryResolutionInput {
    M5ChangeObjectResultEntryResolutionInput {
        entry_id: entry_id.to_owned(),
...
fn downgrade_dogfood_ring_clean() -> M5ResolvedChangeObjectResultEntry {
    ...
    let mut base = clean_downgrade_base(
        ...
        M5ChangeOrchestrationRole::SelectedChangeObjectDisclosure,
        M5ChangeObjectResultScope::EvaluatedScopeBinding,
        M5ChangeObjectRecordSurfaceContext::ShiproomSurface,
...
fn downgrade_rehearsal_currency_clean() -> M5ResolvedChangeObjectResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:program-governance:rehearsal-currency",
        "launch.line.extension-author",
        "line.downgrade.base_head_range_scope",
        M5ChangeOrchestrationRole::StackMembershipDisclosure,
        M5ChangeObjectResultScope::PackVersionDigestBinding,
        M5ChangeObjectRecordSurfaceContext::ProgramGovernanceSurface,
...
fn downgrade_go_no_go_signoff_clean() -> M5ResolvedChangeObjectResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:release-center:go-no-go-signoff",
        "launch.line.certified-journey",
        "line.downgrade.saved_pack_snapshot_scope",
        M5ChangeOrchestrationRole::LandingStateDisclosure,
        M5ChangeObjectResultScope::DivergenceLabelBinding,
        M5ChangeObjectRecordSurfaceContext::ReleaseCenterSurface,
...
fn downgrade_support_ahead() -> M5ResolvedChangeObjectResultEntry {
    let mut base = clean_downgrade_base(
...
/// incomplete.
fn downgrade_form_incomplete() -> M5ResolvedChangeObjectResultEntry {
    let mut base = clean_downgrade_base(
    ...
    base.resolution_form_coverage = vec![M5ChangeObjectRecordResolutionForm::CanonicalObject];
    downgrade(base)
}

/// Degraded downgrade entry: the downgrade scope is unclassified.
fn comparison_review_pack_result_unclassified() -> M5ResolvedChangeObjectResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:executive-steering:scope-unclassified",
        "launch.line.design-partner-preview",
        "line.downgrade.worktree_uncommitted_scope",
        M5ChangeOrchestrationRole::SelectedChangeObjectDisclosure,
        M5ChangeObjectResultScope::ChangeObjectResultUnclassified,
        M5ChangeObjectRecordSurfaceContext::ExecutiveSteeringSurface,
...
#[allow(clippy::too_many_arguments)]
fn base_row(
    consumer_surface: M5ChangeObjectRecordAndResultRegistriesConsumerSurface,
    owner_role: &str,
    scope_summary: &str,
    proof_ref: &str,
    downgrade_triggers: Vec<M5ChangeOrchestrationDowngradeTrigger>,
    review_pack_record_entries: Vec<M5ResolvedChangeObjectRecordEntry>,
    review_pack_result_entries: Vec<M5ResolvedChangeObjectResultEntry>,
) -> M5ChangeObjectRecordAndResultRegistriesRow {
    M5ChangeObjectRecordAndResultRegistriesRow {
        consumer_surface,
        ...
        anatomy_parts: M5ChangeObjectRecordAnatomyPart::ALL.to_vec(),
        export_fields: M5ChangeObjectRecordExportField::ALL.to_vec(),
        downgrade_triggers,
...
fn registry_rows() -> Vec<M5ChangeObjectRecordAndResultRegistriesRow> {
    ...
    vec![
        base_row(
            ...
            "change-object:m5-change-object-detail:001",
            vec![
        ...
        base_row(
            ...
            "change-object:m5-patch-stack-queue:001",
            vec![
                D::StackMembershipSourceUnstated,
        ...
        base_row(
            ...
            "The provider merge queue renders the same resolved change-object record and selected-change-binding truth the resolvers produced across the canonical, accessible, and audit resolution forms rather than a hand-copied sheet; the queue-eligible / queue-blocked / protected-branch-blocked landing state and the validation freshness stay inspectable off-renderer so ambient branch state never reads as a reviewed landing candidate",
            "change-object:m5-provider-merge-queue:001",
            vec![
                D::WorktreeBindingUnstated,
                D::SelectedChangeObjectUnstated,
                D::ChangeOrchestrationMatrixStale,
...
fn governance_review() -> M5ChangeObjectRecordAndResultRegistriesGovernanceReview {
    M5ChangeObjectRecordAndResultRegistriesGovernanceReview {
...
fn consumer_projection() -> M5ChangeObjectRecordAndResultRegistriesConsumerProjection {
    M5ChangeObjectRecordAndResultRegistriesConsumerProjection {
...
fn proof_freshness() -> M5ChangeObjectRecordAndResultRegistriesProofFreshness {
    M5ChangeObjectRecordAndResultRegistriesProofFreshness {
...
fn release_posture() -> M5ChangeObjectRecordAndResultRegistriesReleasePosture {
    M5ChangeObjectRecordAndResultRegistriesReleasePosture {
        proof_packet_ref: M5_CHANGE_OBJECT_RECORD_AND_RESULT_REGISTRIES_ARTIFACT_REF.to_owned(),
        line_audit_ref: M5_CHANGE_OBJECT_RECORD_AND_RESULT_REGISTRIES_REPORT_REF.to_owned(),
...
pub fn seeded_m5_change_object_record_and_selected_change_binding_registries_review_pack_record_beta_narrowed(
) -> M5ChangeObjectRecordAndResultRegistriesPacket {
    let mut packet = seeded_m5_change_object_record_and_selected_change_binding_registries();
    packet.packet_id =
        "m5-change-object-record-and-selected-change-binding-registries:change-object-record-beta:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
...
pub fn seeded_m5_change_object_record_and_selected_change_binding_registries_review_pack_result_preview_narrowed(
) -> M5ChangeObjectRecordAndResultRegistriesPacket {
    let mut packet = seeded_m5_change_object_record_and_selected_change_binding_registries();
    packet.packet_id =
        "m5-change-object-record-and-selected-change-binding-registries:selected-change-binding-preview:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
