...
pub const M5_PASTE_SECRET_GUARD_AND_SECRET_GUARD_CONFIRMATION_REGISTRIES_PACKET_ID: &str =
    "m5-paste-secret-guard-and-secret-guard-confirmation-registries:stable:0001";
...
) -> M5ResolvedPasteSecretGuardRecordEntry {
...
) -> M5ResolvedPasteSecretGuardResultEntry {
    resolve_review_pack_result_entry(input).expect("seed line-downgrade-packet entry resolves")
}

fn all_forms() -> Vec<M5PasteSecretGuardRecordResolutionForm> {
    M5PasteSecretGuardRecordResolutionForm::ALL.to_vec()
}
...
fn clean_review_pack_record_base(
    ...
    report_section: M5PasteSecretGuardRecordKind,
    surface_context: M5PasteSecretGuardRecordSurfaceContext,
...
) -> M5PasteSecretGuardRecordEntryResolutionInput {
    M5PasteSecretGuardRecordEntryResolutionInput {
...
fn review_pack_record_changed_files_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5PasteSecretGuardRecordKind::ChangedFilesScope,
        M5PasteSecretGuardRecordSurfaceContext::ShiproomSurface,
...
fn review_pack_record_pull_request_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5PasteSecretGuardRecordKind::PullRequestScope,
        M5PasteSecretGuardRecordSurfaceContext::ReleaseCenterSurface,
...
fn review_pack_record_base_head_range_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5PasteSecretGuardRecordKind::BaseHeadRangeScope,
        M5PasteSecretGuardRecordSurfaceContext::ProgramGovernanceSurface,
...
fn review_pack_record_worktree_uncommitted_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    ...
    let mut base = clean_review_pack_record_base(
        ...
        M5CollaborationControlRole::ControlAuthorityDisclosure,
        M5PasteSecretGuardRecordKind::WorktreeUncommittedScope,
        M5PasteSecretGuardRecordSurfaceContext::ExecutiveSteeringSurface,
...
fn review_pack_record_full_tree_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    ...
    let mut base = clean_review_pack_record_base(
        ...
        M5CollaborationControlRole::ActiveDriverDisclosure,
        M5PasteSecretGuardRecordKind::FullTreeScope,
        M5PasteSecretGuardRecordSurfaceContext::SupportOrExportForm,
...
fn review_pack_record_saved_pack_snapshot_scope_clean() -> M5ResolvedPasteSecretGuardRecordEntry {
    review_pack_record(clean_review_pack_record_base(
        ...
        M5PasteSecretGuardRecordKind::SavedPackSnapshotScope,
        M5PasteSecretGuardRecordSurfaceContext::ReleaseCenterSurface,
...
fn review_pack_record_object_incomplete() -> M5ResolvedPasteSecretGuardRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn review_pack_record_widen_fold() -> M5ResolvedPasteSecretGuardRecordEntry {
    let mut base = clean_review_pack_record_base(
...
/// registry.
fn review_pack_record_unbound() -> M5ResolvedPasteSecretGuardRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn review_pack_record_token_unstated() -> M5ResolvedPasteSecretGuardRecordEntry {
    let mut base = clean_review_pack_record_base(
...
fn clean_downgrade_base(
    ...
    token_name: &str,
    semantic_role: M5CollaborationControlRole,
    comparison_scope: M5PasteSecretGuardResultScope,
    surface_context: M5PasteSecretGuardRecordSurfaceContext,
...
) -> M5PasteSecretGuardResultEntryResolutionInput {
    M5PasteSecretGuardResultEntryResolutionInput {
        entry_id: entry_id.to_owned(),
...
fn downgrade_dogfood_ring_clean() -> M5ResolvedPasteSecretGuardResultEntry {
    ...
    let mut base = clean_downgrade_base(
        ...
        M5CollaborationControlRole::ControlAuthorityDisclosure,
        M5PasteSecretGuardResultScope::EvaluatedScopeBinding,
        M5PasteSecretGuardRecordSurfaceContext::ShiproomSurface,
...
fn downgrade_rehearsal_currency_clean() -> M5ResolvedPasteSecretGuardResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:program-governance:rehearsal-currency",
        "launch.line.extension-author",
        "line.downgrade.base_head_range_scope",
        M5CollaborationControlRole::ViewFirstDefaultDisclosure,
        M5PasteSecretGuardResultScope::PackVersionDigestBinding,
        M5PasteSecretGuardRecordSurfaceContext::ProgramGovernanceSurface,
...
fn downgrade_go_no_go_signoff_clean() -> M5ResolvedPasteSecretGuardResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:release-center:go-no-go-signoff",
        "launch.line.certified-journey",
        "line.downgrade.saved_pack_snapshot_scope",
        M5CollaborationControlRole::ConsentScopeDisclosure,
        M5PasteSecretGuardResultScope::DivergenceLabelBinding,
        M5PasteSecretGuardRecordSurfaceContext::ReleaseCenterSurface,
...
fn downgrade_support_ahead() -> M5ResolvedPasteSecretGuardResultEntry {
    let mut base = clean_downgrade_base(
...
/// incomplete.
fn downgrade_form_incomplete() -> M5ResolvedPasteSecretGuardResultEntry {
    let mut base = clean_downgrade_base(
    ...
    base.resolution_form_coverage = vec![M5PasteSecretGuardRecordResolutionForm::CanonicalObject];
    downgrade(base)
}

/// Degraded downgrade entry: the downgrade scope is unclassified.
fn comparison_review_pack_result_unclassified() -> M5ResolvedPasteSecretGuardResultEntry {
    downgrade(clean_downgrade_base(
        "downgrade:executive-steering:scope-unclassified",
        "launch.line.design-partner-preview",
        "line.downgrade.worktree_uncommitted_scope",
        M5CollaborationControlRole::ControlAuthorityDisclosure,
        M5PasteSecretGuardResultScope::ChangeObjectResultUnclassified,
        M5PasteSecretGuardRecordSurfaceContext::ExecutiveSteeringSurface,
...
#[allow(clippy::too_many_arguments)]
fn base_row(
    consumer_surface: M5PasteSecretGuardRecordAndResultRegistriesConsumerSurface,
    owner_role: &str,
    scope_summary: &str,
    proof_ref: &str,
    downgrade_triggers: Vec<M5CollaborationControlDowngradeTrigger>,
    review_pack_record_entries: Vec<M5ResolvedPasteSecretGuardRecordEntry>,
    review_pack_result_entries: Vec<M5ResolvedPasteSecretGuardResultEntry>,
) -> M5PasteSecretGuardRecordAndResultRegistriesRow {
    M5PasteSecretGuardRecordAndResultRegistriesRow {
        consumer_surface,
        ...
        anatomy_parts: M5PasteSecretGuardRecordAnatomyPart::ALL.to_vec(),
        export_fields: M5PasteSecretGuardRecordExportField::ALL.to_vec(),
        downgrade_triggers,
...
fn registry_rows() -> Vec<M5PasteSecretGuardRecordAndResultRegistriesRow> {
    ...
    vec![
        ...
        base_row(
            ...
            "paste-secret-guard:m5-control-grant-prompt:001",
            vec![
                D::ControlAuthorityUnstated,
        ...
        base_row(
            ...
            "The paste / secret guard renders the same resolved paste-secret guard and secret-guard confirmation truth the resolvers produced across the canonical, accessible, and audit resolution forms rather than a hand-copied sheet; the step-up posture and the guard binding stay inspectable off-renderer so raw secrets, command text, variable bodies, or clipboard contents are never revealed without an explicit policy / consent posture and visible guardrail",
            "paste-secret-guard:m5-paste-secret-guard:001",
            vec![
                D::ActiveDriverUnstated,
                D::ControlAuthorityUnstated,
                D::CollaborationControlMatrixStale,
...
fn governance_review() -> M5PasteSecretGuardRecordAndResultRegistriesGovernanceReview {
    M5PasteSecretGuardRecordAndResultRegistriesGovernanceReview {
...
fn consumer_projection() -> M5PasteSecretGuardRecordAndResultRegistriesConsumerProjection {
    M5PasteSecretGuardRecordAndResultRegistriesConsumerProjection {
...
fn proof_freshness() -> M5PasteSecretGuardRecordAndResultRegistriesProofFreshness {
    M5PasteSecretGuardRecordAndResultRegistriesProofFreshness {
...
fn release_posture() -> M5PasteSecretGuardRecordAndResultRegistriesReleasePosture {
    M5PasteSecretGuardRecordAndResultRegistriesReleasePosture {
        proof_packet_ref:
            M5_PASTE_SECRET_GUARD_AND_SECRET_GUARD_CONFIRMATION_REGISTRIES_ARTIFACT_REF.to_owned(),
        line_audit_ref: M5_PASTE_SECRET_GUARD_AND_SECRET_GUARD_CONFIRMATION_REGISTRIES_REPORT_REF
            .to_owned(),
...
pub fn seeded_m5_paste_secret_guard_and_secret_guard_confirmation_registries_review_pack_record_beta_narrowed(
) -> M5PasteSecretGuardRecordAndResultRegistriesPacket {
    let mut packet = seeded_m5_paste_secret_guard_and_secret_guard_confirmation_registries();
    packet.packet_id =
        "m5-paste-secret-guard-and-secret-guard-confirmation-registries:paste-secret-guard-beta:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
...
pub fn seeded_m5_paste_secret_guard_and_secret_guard_confirmation_registries_review_pack_result_preview_narrowed(
) -> M5PasteSecretGuardRecordAndResultRegistriesPacket {
    let mut packet = seeded_m5_paste_secret_guard_and_secret_guard_confirmation_registries();
    packet.packet_id =
        "m5-paste-secret-guard-and-secret-guard-confirmation-registries:secret-guard-confirmation-preview:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
