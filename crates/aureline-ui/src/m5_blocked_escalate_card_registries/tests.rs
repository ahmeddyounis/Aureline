...
fn clean_review_pack_record_input() -> M5BlockedEscalateCardEntryResolutionInput {
    M5BlockedEscalateCardEntryResolutionInput {
        ...
        report_section: M5BlockedEscalateCardKind::ChangedFilesScope,
        surface_context: M5BlockedEscalateCardSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5BlockedEscalateCardResolutionForm::ALL.to_vec(),
...
fn clean_downgrade_input() -> M5BlockedEscalateOutcomeEntryResolutionInput {
    M5BlockedEscalateOutcomeEntryResolutionInput {
        ...
        semantic_role: M5ChangeIntentRole::ProviderOwnershipDisclosure,
        comparison_scope: M5BlockedEscalateOutcomeScope::EvaluatedScopeBinding,
        surface_context: M5BlockedEscalateCardSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5BlockedEscalateCardResolutionForm::ALL.to_vec(),
...
fn review_pack_record_clean_names_meaning_and_is_bound() {
    ...
    assert_eq!(
        ...
        M5BlockedEscalateCardNextAction::ExpandCohortMeaning
    );
}
...
fn review_pack_record_unbound_and_unclassified_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5BlockedEscalateCardKind::PackScopeUnclassified;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_object_incomplete_and_widen_fold_and_form_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.resolution_form_coverage = vec![M5BlockedEscalateCardResolutionForm::CanonicalObject];
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_public_facing_and_surface_and_proof_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5BlockedEscalateCardKind::FullTreeScope;
    ...
    let mut input = clean_review_pack_record_input();
    input.surface_context = M5BlockedEscalateCardSurfaceContext::ContextUnknown;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_empty_id_and_forbidden_material_error() {
    ...
    assert_eq!(
        ...
        M5BlockedEscalateCardResolutionError::EmptyCohortDescriptorEntryId
    );
    ...
    assert_eq!(
        resolve_review_pack_record_entry(input).unwrap_err(),
        M5BlockedEscalateCardResolutionError::ForbiddenMaterial
    );
}
...
fn line_preserves_rollback_and_diagnostics_rejects_unpreserved() {
    ...
    assert!(!line_preserves_rollback_and_diagnostics_before_widening(
        M5BlockedEscalateCardKind::PackScopeUnclassified,
        true,
        false,
        true
    ));
...
fn downgrade_support_ahead_and_unclassified_degrade() {
    ...
    let mut input = clean_downgrade_input();
    input.comparison_scope = M5BlockedEscalateOutcomeScope::ChangeIntentResultUnclassified;
    assert_eq!(
...
fn downgrade_form_and_surface_and_id_and_material() {
    ...
    assert_eq!(
        ...
        M5BlockedEscalateCardResolutionError::EmptyCohortEvidencePacketEntryId
    );
...
fn vocabulary_set_is_canonical() {
    assert!(seeded_m5_blocked_escalate_card_registries()
        .vocabulary_set
        .matches_canonical());
}
...
fn vocabulary_set_drift_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::VocabularySetDrift));
}
...
fn missing_source_contracts_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::MissingSourceContracts));
}
...
fn domain_schema_ref_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::DomainSchemaRefMissing));

    let mut packet = seeded_m5_blocked_escalate_card_registries();
    packet.registry_rows[0]
        .source_contract_refs
        .retain(|r| r != M5_BLOCKED_ESCALATE_CARD_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::DomainSchemaRefMissing));
}
...
fn mandatory_anatomy_missing_fails() {
    ...
    packet.registry_rows[0]
        .anatomy_parts
        .retain(|p| *p != M5BlockedEscalateCardAnatomyPart::Identity);
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::MandatoryAnatomyMissing));
}
...
fn mandatory_export_field_missing_fails() {
    ...
    packet.registry_rows[0]
        .export_fields
        .retain(|f| *f != M5BlockedEscalateCardExportField::CohortArchetypes);
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::MandatoryExportFieldMissing));
}
...
fn examples_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::ExamplesMissing));
}
...
fn dishonest_clean_example_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::DishonestExample));
}
...
fn row_invariant_violation_fails() {
    for mutate in 0u8..4 {
        ...
        assert!(packet
            .validate()
            .contains(&M5BlockedEscalateCardRegistriesViolation::RowInvariantViolated));
    }
}
...
fn review_pack_record_not_proven_when_incomplete_example_removed() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::CohortDescriptorResolutionNotProven));
}
...
fn review_pack_result_integrity_not_proven_when_support_ahead_example_removed() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::CohortEvidenceIntegrityNotProven));
}
...
fn governance_review_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::GovernanceReviewIncomplete));
}
...
fn consumer_projection_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::ConsumerProjectionIncomplete));
}
...
fn proof_freshness_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::ProofFreshnessIncomplete));
}
...
fn release_posture_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::ReleasePostureIncomplete));
}
...
fn injected_raw_material_is_rejected() {
    ...
    assert!(packet
        .validate()
        .contains(&M5BlockedEscalateCardRegistriesViolation::RawMaterialInExport));
}

#[test]
fn export_carries_no_forbidden_raw_material() {
    let json = seeded_m5_blocked_escalate_card_registries().export_safe_json();
...
fn checked_support_export_validates_and_matches_seed() {
    let from_disk = current_stable_m5_blocked_escalate_card_registries_export().expect(
...
fn narrowed_variants_validate_and_keep_rows_visible() {
    let beta = seeded_m5_blocked_escalate_card_registries_review_pack_record_beta_narrowed();
    ...
    let preview = seeded_m5_blocked_escalate_card_registries_review_pack_result_preview_narrowed();
...
fn checked_narrowed_fixtures_validate_and_match_seed_builders() {
    let beta: M5BlockedEscalateCardRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-blocked-escalate-card-registries/blocked_escalate_card_beta_narrowed.json"
    )))
    ...
    let preview: M5BlockedEscalateCardRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-blocked-escalate-card-registries/blocked_escalate_outcome_preview_narrowed.json"
    )))
