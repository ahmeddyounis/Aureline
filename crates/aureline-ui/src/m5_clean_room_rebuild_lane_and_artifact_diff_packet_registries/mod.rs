...
//!
//! * **Publish one typed clean-room-rebuild-lane object per lane.** [`resolve_clean_room_rebuild_lane_entry`]
//!   refuses to read as a clean, registry-bound manifest entry unless it names a canonical registry token, a
//!   classified [input source][M5CleanRoomRebuildSourceKind], a build-lane-trust role, covers every [resolution
//!   form][M5CleanRoomResolutionForm] (the canonical object, the accessible summary, and the audit record),
...
//!   [`M5CleanRoomRebuildLaneEntryDegradeReason::LaneReliesOnSharedCacheOrHidesReplayReceipt`], and a trust-risk
...
//!   [`resolve_artifact_diff_packet_entry`] names a classified [convergence
//!   scope][M5ArtifactDiffScope], requires the full build-identity / claimed-families / sidecar-ledger /
...
//!   [`M5ArtifactDiffPacketEntryDegradeReason::ArtifactDiffDivergesOrOmitsFamilyOrDriftsBuildIdentity`]
...
pub use seed::{
    ...
    M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_PACKET_ID,
};
...
/// Stable record-kind tag carried by [`M5CleanRoomRebuildArtifactDiffRegistriesPacket`].
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_RECORD_KIND: &str =
    "implement_m5_clean_room_rebuild_lane_and_artifact_diff_packet_registries";

/// Schema version for M5 clean-room-rebuild-lane / artifact-diff-packet registry records.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_VERSION: u32 = 1;

/// Repo-relative path of the combined registries schema.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_REF: &str =
...
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_DOC_REF: &str =
    "docs/release/m5_clean_room_rebuild_lane_and_artifact_diff_packet_registries.md";

/// Repo-relative path of the checked support-export artifact.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_ARTIFACT_REF: &str =
    "artifacts/release/m5-clean-room-rebuild-lane-and-artifact-diff-packet-registries-proof/support_export.json";

/// Repo-relative path of the checked machine-readable registries CSV.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_CSV_REF: &str =
    "artifacts/release/m5-clean-room-rebuild-lane-and-artifact-diff-packet-registries-proof/matrix.csv";

/// Repo-relative path of the checked Markdown design report.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_REPORT_REF: &str =
    "artifacts/release/m5-clean-room-rebuild-lane-and-artifact-diff-packet-registries-proof/summary.md";

/// Repo-relative path of the protected fixture directory.
pub const M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_FIXTURE_DIR: &str =
...
pub const M5_CLEAN_ROOM_REBUILD_LANE_DOMAIN_SCHEMA_REF: &str =
    "schemas/release/m5-clean-room-rebuild-lane.schema.json";
...
pub const M5_ARTIFACT_DIFF_PACKET_DOMAIN_SCHEMA_REF: &str =
    "schemas/release/m5-artifact-diff-packet.schema.json";
...
pub type M5CleanRoomRebuildArtifactDiffRegistriesConsumerSurface = M5BuildLaneConsumerSurface;
...
pub enum M5CleanRoomResolutionForm {
...
impl M5CleanRoomResolutionForm {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomRebuildSourceKind {
...
impl M5CleanRoomRebuildSourceKind {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomSurfaceContext {
...
impl M5CleanRoomSurfaceContext {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomAnatomyPart {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomNextAction {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomExportField {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5CleanRoomRebuildLaneEntryDegradeReason {
    ...
    CleanRoomRebuildLaneObjectIncomplete,
...
impl M5CleanRoomRebuildLaneEntryDegradeReason {
    ...
    pub const ALL: [Self; 9] = [
        ...
        Self::CleanRoomRebuildLaneObjectIncomplete,
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CleanRoomRebuildLaneObjectIncomplete => {
                "clean_room_rebuild_lane_object_incomplete"
            }
            Self::LaneReliesOnSharedCacheOrHidesReplayReceipt => {
    ...
    pub const fn next_action(self) -> M5CleanRoomNextAction {
        match self {
            Self::RegistryTokenUnstated | Self::LaneNotBoundToRegistry => {
                M5CleanRoomNextAction::TraceCanonicalRegistry
            }
            Self::RebuildSourceUnclassified
            | Self::CleanRoomRebuildLaneObjectIncomplete
            | Self::LaneReliesOnSharedCacheOrHidesReplayReceipt => {
                M5CleanRoomNextAction::InspectSourceOrScope
            }
            Self::ResolutionFormCoverageIncomplete => {
                M5CleanRoomNextAction::CompleteResolutionFormCoverage
            }
            Self::SurfaceContextUnresolved
            | Self::CacheTrustNotDisclosedForSharedCacheSource
            | Self::ProofStale => M5CleanRoomNextAction::ReviewBlockedOrDegraded,
        }
    }
    ...
    pub const fn downgrade_trigger(self) -> M5BuildLaneDowngradeTrigger {
        match self {
            ...
            Self::RebuildSourceUnclassified | Self::CleanRoomRebuildLaneObjectIncomplete => {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ArtifactDiffPacketEntryDegradeReason {
...
impl M5ArtifactDiffPacketEntryDegradeReason {
    /// Every degrade reason, in declaration order.
    pub const ALL: [Self; 6] = [
        Self::RegistryTokenUnstated,
        Self::SurfaceContextUnresolved,
    ...
    pub const fn next_action(self) -> M5CleanRoomNextAction {
        match self {
            Self::RegistryTokenUnstated => M5CleanRoomNextAction::TraceCanonicalRegistry,
            Self::DiffScopeUnclassified
            | Self::ArtifactDiffDivergesOrOmitsFamilyOrDriftsBuildIdentity => {
                M5CleanRoomNextAction::InspectSourceOrScope
            }
            ...
            Self::SurfaceContextUnresolved | Self::ProofStale => {
                M5CleanRoomNextAction::ReviewBlockedOrDegraded
            }
        }
    }
...
/// Input to [`resolve_clean_room_rebuild_lane_entry`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5CleanRoomRebuildLaneEntryResolutionInput {
    ...
    pub rebuild_source: M5CleanRoomRebuildSourceKind,
    /// The render / surface context.
    pub surface_context: M5CleanRoomSurfaceContext,
    /// The resolution forms this entry holds across (must cover canonical / accessible / audit).
    pub resolution_form_coverage: Vec<M5CleanRoomResolutionForm>,
...
pub struct M5ResolvedCleanRoomRebuildLaneEntry {
    /// Stable identity of the clean-room-rebuild-lane-registry entry.
    pub entry_id: String,
    ...
    pub clean_room_rebuild_lane_object_complete: bool,
    ...
    pub degrade_reason: Option<M5CleanRoomRebuildLaneEntryDegradeReason>,
    /// Next safe action offered.
    pub next_action: M5CleanRoomNextAction,
...
impl M5ResolvedCleanRoomRebuildLaneEntry {
...
/// Input to [`resolve_artifact_diff_packet_entry`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5ArtifactDiffPacketEntryResolutionInput {
    ...
    pub diff_scope: M5ArtifactDiffScope,
    /// The render / surface context.
    pub surface_context: M5CleanRoomSurfaceContext,
    /// The resolution forms this entry holds across (must cover canonical / accessible / audit).
    pub resolution_form_coverage: Vec<M5CleanRoomResolutionForm>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5ResolvedArtifactDiffPacketEntry {
    /// Stable identity of the artifact-diff-packet entry.
    pub entry_id: String,
    ...
    pub degrade_reason: Option<M5ArtifactDiffPacketEntryDegradeReason>,
    /// Next safe action offered.
    pub next_action: M5CleanRoomNextAction,
...
impl M5ResolvedArtifactDiffPacketEntry {
...
pub enum M5CleanRoomResolutionError {
    /// The clean-room-rebuild-lane-entry id was empty.
    EmptyCleanRoomRebuildLaneEntryId,
    /// The artifact-diff-packet-entry id was empty.
    EmptyArtifactDiffPacketEntryId,
    /// A field carried forbidden raw material (secret / endpoint).
    ForbiddenMaterial,
}

impl M5CleanRoomResolutionError {
    /// Stable token used in tests and exports.
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::EmptyCleanRoomRebuildLaneEntryId => "empty_clean_room_rebuild_lane_entry_id",
            Self::EmptyArtifactDiffPacketEntryId => "empty_artifact_diff_packet_entry_id",
            Self::ForbiddenMaterial => "forbidden_material",
        }
    }
}

impl fmt::Display for M5CleanRoomResolutionError {
...
impl Error for M5CleanRoomResolutionError {}

fn form_tokens(forms: &[M5CleanRoomResolutionForm]) -> Vec<String> {
    forms.iter().map(|f| f.as_str().to_owned()).collect()
}

fn covers_all_resolution_forms(forms: &[M5CleanRoomResolutionForm]) -> bool {
    let present: BTreeSet<M5CleanRoomResolutionForm> = forms.iter().copied().collect();
    M5CleanRoomResolutionForm::ALL
        .iter()
...
pub fn clean_room_rebuild_lane_object_is_complete(
    source: M5CleanRoomRebuildSourceKind,
...
pub fn resolve_clean_room_rebuild_lane_entry(
    input: M5CleanRoomRebuildLaneEntryResolutionInput,
) -> Result<M5ResolvedCleanRoomRebuildLaneEntry, M5CleanRoomResolutionError> {
    if input.entry_id.trim().is_empty() {
        return Err(M5CleanRoomResolutionError::EmptyCleanRoomRebuildLaneEntryId);
    }
    ...
    {
        return Err(M5CleanRoomResolutionError::ForbiddenMaterial);
    }

    let all_forms = covers_all_resolution_forms(&input.resolution_form_coverage);
    let object_complete = clean_room_rebuild_lane_object_is_complete(
    ...
    let degrade_reason = if input.token_name.trim().is_empty() {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::RegistryTokenUnstated)
    } else if !input.surface_context.is_resolved() {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::SurfaceContextUnresolved)
    } else if !input.rebuild_source.is_classified() {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::RebuildSourceUnclassified)
    } else if !input.bound_to_registry {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::LaneNotBoundToRegistry)
    } else if !object_complete {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::CleanRoomRebuildLaneObjectIncomplete)
    } else if !admission_ok {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::LaneReliesOnSharedCacheOrHidesReplayReceipt)
    } else if !all_forms {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::ResolutionFormCoverageIncomplete)
    } else if input_trust_undisclosed {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::CacheTrustNotDisclosedForSharedCacheSource)
    } else if !input.proof_fresh {
        Some(M5CleanRoomRebuildLaneEntryDegradeReason::ProofStale)
    } else {
        None
    };
    ...
    let next_action = match degrade_reason {
        ...
        None => M5CleanRoomNextAction::ExpandRebuildMeaning,
    };

    Ok(M5ResolvedCleanRoomRebuildLaneEntry {
        ...
        clean_room_rebuild_lane_object_complete: object_complete,
...
pub fn resolve_artifact_diff_packet_entry(
    input: M5ArtifactDiffPacketEntryResolutionInput,
) -> Result<M5ResolvedArtifactDiffPacketEntry, M5CleanRoomResolutionError> {
    if input.entry_id.trim().is_empty() {
        return Err(M5CleanRoomResolutionError::EmptyArtifactDiffPacketEntryId);
    }
    if string_is_forbidden(&input.entry_id)
    ...
    let degrade_reason = if input.token_name.trim().is_empty() {
        Some(M5ArtifactDiffPacketEntryDegradeReason::RegistryTokenUnstated)
    } else if !input.surface_context.is_resolved() {
        Some(M5ArtifactDiffPacketEntryDegradeReason::SurfaceContextUnresolved)
    } else if !input.diff_scope.is_classified() {
        Some(M5ArtifactDiffPacketEntryDegradeReason::DiffScopeUnclassified)
    } else if !provides_record {
        Some(M5ArtifactDiffPacketEntryDegradeReason::ArtifactDiffDivergesOrOmitsFamilyOrDriftsBuildIdentity)
    } else if !all_forms {
        Some(M5ArtifactDiffPacketEntryDegradeReason::PacketFormCoverageIncomplete)
    } else if !input.proof_fresh {
        Some(M5ArtifactDiffPacketEntryDegradeReason::ProofStale)
    } else {
        None
    };
    ...
    let next_action = match degrade_reason {
        Some(reason) => reason.next_action(),
        None => M5CleanRoomNextAction::TraceCanonicalRegistry,
    };

    Ok(M5ResolvedArtifactDiffPacketEntry {
        entry_id: input.entry_id,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesRow {
    /// Consumer surface this row projects onto.
    pub consumer_surface: M5CleanRoomRebuildArtifactDiffRegistriesConsumerSurface,
    ...
    pub anatomy_parts: Vec<M5CleanRoomAnatomyPart>,
    /// Export fields exposed (must include the mandatory five).
    pub export_fields: Vec<M5CleanRoomExportField>,
    /// Downgrade triggers that apply to this row.
    pub downgrade_triggers: Vec<M5BuildLaneDowngradeTrigger>,
    /// Resolved clean-room-rebuild-lane-registry examples.
    pub clean_room_rebuild_lane_entries: Vec<M5ResolvedCleanRoomRebuildLaneEntry>,
    /// Resolved artifact-diff-packet examples.
    pub artifact_diff_packet_entries: Vec<M5ResolvedArtifactDiffPacketEntry>,
...
impl M5CleanRoomRebuildArtifactDiffRegistriesRow {
    fn declares_mandatory_anatomy(&self) -> bool {
        let present: BTreeSet<M5CleanRoomAnatomyPart> =
            self.anatomy_parts.iter().copied().collect();
        M5CleanRoomAnatomyPart::MANDATORY
            .iter()
            .all(|part| present.contains(part))
    }

    fn declares_mandatory_export_fields(&self) -> bool {
        let present: BTreeSet<M5CleanRoomExportField> =
            self.export_fields.iter().copied().collect();
        M5CleanRoomExportField::MANDATORY
            .iter()
    ...
    /// source.
    fn manifest_is_honest(ex: &M5ResolvedCleanRoomRebuildLaneEntry) -> bool {
        !ex.is_clean()
            || (ex.bound_to_registry
                && ex.rebuild_source_is_classified
                && ex.clean_room_rebuild_lane_object_complete
    ...
    fn sidecar_manifest_is_honest(ex: &M5ResolvedArtifactDiffPacketEntry) -> bool {
        !ex.is_clean()
    ...
    fn examples_are_honest(&self) -> bool {
        self.clean_room_rebuild_lane_entries
            .iter()
            .all(Self::manifest_is_honest)
            && self
                .artifact_diff_packet_entries
                .iter()
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesVocabularySet {
    ...
    pub clean_room_rebuild_lane_degrade_reasons: Vec<String>,
    /// Sidecar-completeness-manifest-entry degrade-reason tokens.
    pub artifact_diff_packet_degrade_reasons: Vec<String>,
    /// Anatomy-part tokens.
...
impl M5CleanRoomRebuildArtifactDiffRegistriesVocabularySet {
    /// Builds the canonical vocabulary set from the typed `ALL` arrays.
    pub fn canonical() -> Self {
        Self {
            semantic_roles: tokens(&M5BuildLaneTrustRole::ALL, |v| v.as_str()),
            resolution_forms: tokens(&M5CleanRoomResolutionForm::ALL, |v| v.as_str()),
            rebuild_source_kinds: tokens(&M5CleanRoomRebuildSourceKind::ALL, |v| v.as_str()),
            diff_scopes: tokens(&M5ArtifactDiffScope::ALL, |v| v.as_str()),
            surface_contexts: tokens(&M5CleanRoomSurfaceContext::ALL, |v| v.as_str()),
            clean_room_rebuild_lane_degrade_reasons: tokens(
                &M5CleanRoomRebuildLaneEntryDegradeReason::ALL,
                |v| v.as_str(),
            ),
            artifact_diff_packet_degrade_reasons: tokens(
                &M5ArtifactDiffPacketEntryDegradeReason::ALL,
                |v| v.as_str(),
            ),
            anatomy_parts: tokens(&M5CleanRoomAnatomyPart::ALL, |v| v.as_str()),
            next_actions: tokens(&M5CleanRoomNextAction::ALL, |v| v.as_str()),
            export_fields: tokens(&M5CleanRoomExportField::ALL, |v| v.as_str()),
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesGovernanceReview {
    /// The clean-room-rebuild registry names a canonical token, semantic role, and input source for every entry.
    pub clean_room_rebuild_registry_names_token_role_and_source: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesConsumerProjection {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesProofFreshness {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesReleasePosture {
...
/// Constructor input for [`M5CleanRoomRebuildArtifactDiffRegistriesPacket::new`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesPacketInput {
    /// Stable packet id.
    pub packet_id: String,
    /// Human-readable registries label.
    pub registries_label: String,
    /// Registry rows.
    pub registry_rows: Vec<M5CleanRoomRebuildArtifactDiffRegistriesRow>,
    /// Frozen controlled-vocabulary set.
    pub vocabulary_set: M5CleanRoomRebuildArtifactDiffRegistriesVocabularySet,
    /// Governance-review block.
    pub governance_review: M5CleanRoomRebuildArtifactDiffRegistriesGovernanceReview,
    /// Consumer projection block.
    pub consumer_projection: M5CleanRoomRebuildArtifactDiffRegistriesConsumerProjection,
    /// Proof freshness block.
    pub proof_freshness: M5CleanRoomRebuildArtifactDiffRegistriesProofFreshness,
    /// Release and support parity posture.
    pub release_posture: M5CleanRoomRebuildArtifactDiffRegistriesReleasePosture,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5CleanRoomRebuildArtifactDiffRegistriesPacket {
    /// Record kind; must equal [`M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_RECORD_KIND`].
    pub record_kind: String,
    /// Schema version; must equal [`M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_VERSION`].
...
impl M5CleanRoomRebuildArtifactDiffRegistriesPacket {
    /// Builds a registries packet from stable-lane input.
    pub fn new(input: M5CleanRoomRebuildArtifactDiffRegistriesPacketInput) -> Self {
        Self {
            record_kind: M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_RECORD_KIND.to_owned(),
            schema_version: M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_VERSION,
    ...
    pub fn validate(&self) -> Vec<M5CleanRoomRebuildArtifactDiffRegistriesViolation> {
        let mut violations = Vec::new();

        if self.record_kind != M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_RECORD_KIND {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::WrongRecordKind);
        }
        if self.schema_version != M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_VERSION {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::WrongSchemaVersion);
        }
        ...
        {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::MissingIdentity);
        }

        validate_source_contracts(self, &mut violations);
        if !self.vocabulary_set.matches_canonical() {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::VocabularySetDrift);
        }
        ...
        if json_contains_forbidden_material(&serde_json::to_value(self).expect(
            ...
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::RawMaterialInExport);
        }
    ...
    pub fn render_matrix_csv(&self) -> String {
        ...
        out.push_str(
            "consumer_surface,qualification,owner,clean_room_rebuild_lane_entries,artifact_diff_packet_entries,degrade_reasons,downgrade_triggers\n",
        );
        for row in &self.registry_rows {
            let degrades: Vec<&str> = row
                .clean_room_rebuild_lane_entries
                .iter()
                .filter_map(|ex| ex.degrade_reason.map(|r| r.as_str()))
                .chain(
                    row.artifact_diff_packet_entries
                        .iter()
                        .filter_map(|ex| ex.degrade_reason.map(|r| r.as_str())),
                )
                .collect();
            out.push_str(&format!(
                ...
                row.clean_room_rebuild_lane_entries.len(),
                row.artifact_diff_packet_entries.len(),
                degrades.join("|"),
    ...
    pub fn render_clean_room_rebuild_lane_table(&self) -> String {
        let mut out = String::new();
        out.push_str(
        ...
        out.push_str("| --- | --- | --- | --- | --- | --- |\n");
        for row in &self.registry_rows {
            for ex in &row.clean_room_rebuild_lane_entries {
                if !ex.is_clean() {
                    continue;
                }
                out.push_str(&format!(
...
#[derive(Debug)]
pub enum M5CleanRoomRebuildArtifactDiffRegistriesArtifactError {
    /// Support export failed to parse.
    SupportExport(serde_json::Error),
    /// Support export failed validation.
    Validation(Vec<M5CleanRoomRebuildArtifactDiffRegistriesViolation>),
}

impl fmt::Display for M5CleanRoomRebuildArtifactDiffRegistriesArtifactError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
...
impl Error for M5CleanRoomRebuildArtifactDiffRegistriesArtifactError {}

/// Validation failures emitted by [`M5CleanRoomRebuildArtifactDiffRegistriesPacket::validate`].
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum M5CleanRoomRebuildArtifactDiffRegistriesViolation {
    ...
    CleanRoomRebuildLaneResolutionNotProven,
...
impl M5CleanRoomRebuildArtifactDiffRegistriesViolation {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CleanRoomRebuildLaneResolutionNotProven => {
                "clean_room_rebuild_lane_resolution_not_proven"
            }
...
pub fn current_stable_m5_clean_room_rebuild_lane_and_artifact_diff_packet_registries_export(
) -> Result<
    M5CleanRoomRebuildArtifactDiffRegistriesPacket,
    M5CleanRoomRebuildArtifactDiffRegistriesArtifactError,
> {
    let packet: M5CleanRoomRebuildArtifactDiffRegistriesPacket = serde_json::from_str(include_str!(
        concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../artifacts/release/m5-clean-room-rebuild-lane-and-artifact-diff-packet-registries-proof/support_export.json"
        )
    ))
    .map_err(M5CleanRoomRebuildArtifactDiffRegistriesArtifactError::SupportExport)?;
    let violations = packet.validate();
    if violations.is_empty() {
        Ok(packet)
    } else {
        Err(M5CleanRoomRebuildArtifactDiffRegistriesArtifactError::Validation(violations))
    }
}

fn validate_source_contracts(
    packet: &M5CleanRoomRebuildArtifactDiffRegistriesPacket,
    violations: &mut Vec<M5CleanRoomRebuildArtifactDiffRegistriesViolation>,
) {
    let refs: BTreeSet<&str> = packet
        ...
        .collect();
    for required in [
        M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_SCHEMA_REF,
        M5_CLEAN_ROOM_REBUILD_ARTIFACT_DIFF_REGISTRIES_DOC_REF,
        M5_BUILD_LANE_TRUST_MATRIX_SCHEMA_REF,
        M5_BUILD_LANE_TRUST_MATRIX_DOC_REF,
        M5_CLEAN_ROOM_REBUILD_LANE_DOMAIN_SCHEMA_REF,
        M5_ARTIFACT_DIFF_PACKET_DOMAIN_SCHEMA_REF,
    ] {
        if !refs.contains(required) {
            violations
                .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::MissingSourceContracts);
            return;
        }
    }
}
...
fn validate_registry_rows(
    ...
    if packet.registry_rows.is_empty() {
        violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::NoRegistryRows);
        return;
    }
    for row in &packet.registry_rows {
        ...
        {
            violations
                .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::RegistryRowIncomplete);
        }
        if !row.declares_mandatory_anatomy() {
            violations
                .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::MandatoryAnatomyMissing);
        }
        if !row.declares_mandatory_export_fields() {
            violations.push(
                M5CleanRoomRebuildArtifactDiffRegistriesViolation::MandatoryExportFieldMissing,
            );
        }
        let refs: BTreeSet<&str> = row
            ...
            .map(String::as_str)
            .collect();
        if !refs.contains(M5_CLEAN_ROOM_REBUILD_LANE_DOMAIN_SCHEMA_REF)
            || !refs.contains(M5_ARTIFACT_DIFF_PACKET_DOMAIN_SCHEMA_REF)
        {
            violations
                .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::DomainSchemaRefMissing);
        }
        if row.clean_room_rebuild_lane_entries.is_empty()
            || row.artifact_diff_packet_entries.is_empty()
        {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::ExamplesMissing);
        }
        if !row.examples_are_honest() {
            violations.push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::DishonestExample);
        }
        if !row.honours_invariants() {
            violations
                .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::RowInvariantViolated);
        }
    }
}
...
fn validate_governance_review(
    ...
    for ok in [
        review.clean_room_rebuild_registry_names_token_role_and_source,
        ...
        if !ok {
            violations.push(
                M5CleanRoomRebuildArtifactDiffRegistriesViolation::GovernanceReviewIncomplete,
            );
            return;
        }
    }
...
fn validate_consumer_projection(
    ...
    for ok in [
        ...
        if !ok {
            violations.push(
                M5CleanRoomRebuildArtifactDiffRegistriesViolation::ConsumerProjectionIncomplete,
            );
            return;
        }
    }
...
fn validate_proof_freshness(
    ...
    {
        violations
            .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::ProofFreshnessIncomplete);
    }
}
...
fn validate_release_posture(
    ...
    {
        violations
            .push(M5CleanRoomRebuildArtifactDiffRegistriesViolation::ReleasePostureIncomplete);
    }
}
...
fn validate_acceptance_criteria(
    ...
    let manifests = || {
        packet
            .registry_rows
            .iter()
            .flat_map(|row| row.clean_room_rebuild_lane_entries.iter())
    };
    let sidecars = || {
        packet
            .registry_rows
            .iter()
            .flat_map(|row| row.artifact_diff_packet_entries.iter())
    };
    ...
    let clean_surfaces: BTreeSet<String> = manifests()
        ...
        .collect();
    let sources_covered = M5CleanRoomRebuildSourceKind::CANONICAL_SOURCES
        .iter()
        .all(|k| clean_sources.contains(k.as_str()));
    let first_surfaces_covered = M5CleanRoomSurfaceContext::FIRST_CONSUMERS
        .iter()
    ...
    let no_clean_incomplete =
        !manifests().any(|ex| ex.is_clean() && !ex.clean_room_rebuild_lane_object_complete);
    if !(sources_covered
    ...
    {
        violations.push(
            M5CleanRoomRebuildArtifactDiffRegistriesViolation::CleanRoomRebuildLaneResolutionNotProven,
        );
    }
    ...
    let unbound_degrades = manifests().any(|ex| {
        ex.degrade_reason == Some(M5CleanRoomRebuildLaneEntryDegradeReason::LaneNotBoundToRegistry)
    });
    ...
    {
        violations.push(
            M5CleanRoomRebuildArtifactDiffRegistriesViolation::SharedCacheAuthorityBoundaryNotProven,
        );
    }
    ...
    let clean_sidecar_scopes: BTreeSet<String> = sidecars()
        ...
        .collect();
    let sidecar_scopes_covered = M5ArtifactDiffScope::CANONICAL_SCOPES
        .iter()
    ...
    {
        violations.push(
            M5CleanRoomRebuildArtifactDiffRegistriesViolation::ArtifactDiffDeterminismNotProven,
        );
    }
}
