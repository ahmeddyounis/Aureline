//! Implemented M5 exact-build-symbolication and mirror-offline-parity registries.
//!
//! This is the exact-build-symbolication and mirror/offline-publication-parity implement lane: it binds crash
//! packets, symbol / source-map manifests, support bundles, and symbolication reports to the same exact-build
//! descriptor B144 produces so a support bundle can explain exact versus approximate symbolication against one
//! build identity, and it proves mirrored / offline publication preserves the same build identity and freshness
//! vocabulary as default publication so a mismatched build ID or an omitted family is a blocker rather than a
//! warning. The registry field and token names are inherited verbatim from the shared two-registry lane shape
//! (an unverified input never enters a protected lane; a missing or mismatched sidecar degrades honestly).
//!
...
//!
//! * **Publish one typed clean-room-rebuild-lane object per lane.** [`resolve_exact_build_symbolication_entry`]
//!   refuses to read as a clean, registry-bound manifest entry unless it names a canonical registry token, a
//!   classified [input source][M5SymbolicationFidelityKind], a build-lane-trust role, covers every [resolution
//!   form][M5ExactBuildSupportResolutionForm] (the canonical object, the accessible summary, and the audit record),
...
//!   [`M5ExactBuildSymbolicationEntryDegradeReason::LaneReliesOnSharedCacheOrHidesReplayReceipt`], and a trust-risk
...
//!   [`resolve_mirror_offline_parity_entry`] names a classified [convergence
//!   scope][M5MirrorOfflineParityScope], requires the full build-identity / claimed-families / sidecar-ledger /
...
//!   [`M5MirrorOfflineParityEntryDegradeReason::ArtifactDiffDivergesOrOmitsFamilyOrDriftsBuildIdentity`]
...
/// Stable record-kind tag carried by [`M5SymbolicationMirrorParityRegistriesPacket`].
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_RECORD_KIND: &str =
    "implement_m5_exact_build_symbolication_and_mirror_offline_parity_registries";

/// Schema version for M5 clean-room-rebuild-lane / artifact-diff-packet registry records.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_SCHEMA_VERSION: u32 = 1;

/// Repo-relative path of the combined registries schema.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_SCHEMA_REF: &str =
    "schemas/release/m5-exact-build-symbolication-and-mirror-offline-parity-registries.schema.json";

/// Repo-relative path of the registries doc.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_DOC_REF: &str =
    "docs/release/m5_exact_build_symbolication_and_mirror_offline_parity_registries.md";

/// Repo-relative path of the checked support-export artifact.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_ARTIFACT_REF: &str =
    "artifacts/release/m5-exact-build-symbolication-and-mirror-offline-parity-registries-proof/support_export.json";

/// Repo-relative path of the checked machine-readable registries CSV.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_CSV_REF: &str =
    "artifacts/release/m5-exact-build-symbolication-and-mirror-offline-parity-registries-proof/matrix.csv";

/// Repo-relative path of the checked Markdown design report.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_REPORT_REF: &str =
    "artifacts/release/m5-exact-build-symbolication-and-mirror-offline-parity-registries-proof/summary.md";

/// Repo-relative path of the protected fixture directory.
pub const M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_FIXTURE_DIR: &str =
...
pub const M5_EXACT_BUILD_SYMBOLICATION_DOMAIN_SCHEMA_REF: &str =
    "schemas/release/m5-exact-build-symbolication.schema.json";
...
pub const M5_MIRROR_OFFLINE_PARITY_DOMAIN_SCHEMA_REF: &str =
    "schemas/release/m5-mirror-offline-parity.schema.json";
...
pub type M5SymbolicationMirrorParityRegistriesConsumerSurface = M5BuildLaneConsumerSurface;
...
pub enum M5ExactBuildSupportResolutionForm {
...
impl M5ExactBuildSupportResolutionForm {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5SymbolicationFidelityKind {
...
impl M5SymbolicationFidelityKind {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5MirrorOfflineParityScope {
...
impl M5MirrorOfflineParityScope {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ExactBuildSupportSurfaceContext {
...
impl M5ExactBuildSupportSurfaceContext {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ExactBuildSupportAnatomyPart {
...
impl M5ExactBuildSupportAnatomyPart {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ExactBuildSupportNextAction {
...
impl M5ExactBuildSupportNextAction {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ExactBuildSupportExportField {
...
impl M5ExactBuildSupportExportField {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5ExactBuildSymbolicationEntryDegradeReason {
    ...
    ExactBuildSymbolicationObjectIncomplete,
...
impl M5ExactBuildSymbolicationEntryDegradeReason {
    ...
    pub const ALL: [Self; 9] = [
        ...
        Self::ExactBuildSymbolicationObjectIncomplete,
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ExactBuildSymbolicationObjectIncomplete => {
                "exact_build_symbolication_object_incomplete"
            }
            Self::LaneReliesOnSharedCacheOrHidesReplayReceipt => {
    ...
    pub const fn next_action(self) -> M5ExactBuildSupportNextAction {
        match self {
            Self::RegistryTokenUnstated | Self::LaneNotBoundToRegistry => {
                M5ExactBuildSupportNextAction::TraceCanonicalRegistry
            }
            Self::RebuildSourceUnclassified
            | Self::ExactBuildSymbolicationObjectIncomplete
            | Self::LaneReliesOnSharedCacheOrHidesReplayReceipt => {
                M5ExactBuildSupportNextAction::InspectSourceOrScope
            }
            Self::ResolutionFormCoverageIncomplete => {
                M5ExactBuildSupportNextAction::CompleteResolutionFormCoverage
            }
            Self::SurfaceContextUnresolved
            | Self::CacheTrustNotDisclosedForSharedCacheSource
            | Self::ProofStale => M5ExactBuildSupportNextAction::ReviewBlockedOrDegraded,
        }
    }
    ...
    pub const fn downgrade_trigger(self) -> M5BuildLaneDowngradeTrigger {
        match self {
            ...
            Self::RebuildSourceUnclassified | Self::ExactBuildSymbolicationObjectIncomplete => {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum M5MirrorOfflineParityEntryDegradeReason {
...
impl M5MirrorOfflineParityEntryDegradeReason {
    /// Every degrade reason, in declaration order.
    pub const ALL: [Self; 6] = [
        Self::RegistryTokenUnstated,
        Self::SurfaceContextUnresolved,
    ...
    pub const fn next_action(self) -> M5ExactBuildSupportNextAction {
        match self {
            Self::RegistryTokenUnstated => M5ExactBuildSupportNextAction::TraceCanonicalRegistry,
            Self::DiffScopeUnclassified
            | Self::ArtifactDiffDivergesOrOmitsFamilyOrDriftsBuildIdentity => {
                M5ExactBuildSupportNextAction::InspectSourceOrScope
            }
            ...
            Self::SurfaceContextUnresolved | Self::ProofStale => {
                M5ExactBuildSupportNextAction::ReviewBlockedOrDegraded
            }
        }
    }
...
/// Input to [`resolve_exact_build_symbolication_entry`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5ExactBuildSymbolicationEntryResolutionInput {
    ...
    pub rebuild_source: M5SymbolicationFidelityKind,
    /// The render / surface context.
    pub surface_context: M5ExactBuildSupportSurfaceContext,
    /// The resolution forms this entry holds across (must cover canonical / accessible / audit).
    pub resolution_form_coverage: Vec<M5ExactBuildSupportResolutionForm>,
...
pub struct M5ResolvedExactBuildSymbolicationEntry {
    /// Stable identity of the clean-room-rebuild-lane-registry entry.
    pub entry_id: String,
    ...
    pub exact_build_symbolication_object_complete: bool,
    ...
    pub degrade_reason: Option<M5ExactBuildSymbolicationEntryDegradeReason>,
    /// Next safe action offered.
    pub next_action: M5ExactBuildSupportNextAction,
...
impl M5ResolvedExactBuildSymbolicationEntry {
...
/// Input to [`resolve_mirror_offline_parity_entry`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5MirrorOfflineParityEntryResolutionInput {
    ...
    pub diff_scope: M5MirrorOfflineParityScope,
    /// The render / surface context.
    pub surface_context: M5ExactBuildSupportSurfaceContext,
    /// The resolution forms this entry holds across (must cover canonical / accessible / audit).
    pub resolution_form_coverage: Vec<M5ExactBuildSupportResolutionForm>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5ResolvedMirrorOfflineParityEntry {
    /// Stable identity of the artifact-diff-packet entry.
    pub entry_id: String,
    ...
    pub degrade_reason: Option<M5MirrorOfflineParityEntryDegradeReason>,
    /// Next safe action offered.
    pub next_action: M5ExactBuildSupportNextAction,
...
impl M5ResolvedMirrorOfflineParityEntry {
...
pub enum M5ExactBuildSupportResolutionError {
    /// The clean-room-rebuild-lane-entry id was empty.
    EmptyExactBuildSymbolicationEntryId,
    /// The artifact-diff-packet-entry id was empty.
    EmptyMirrorOfflineParityEntryId,
    /// A field carried forbidden raw material (secret / endpoint).
    ForbiddenMaterial,
}

impl M5ExactBuildSupportResolutionError {
    /// Stable token used in tests and exports.
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::EmptyExactBuildSymbolicationEntryId => "empty_exact_build_symbolication_entry_id",
            Self::EmptyMirrorOfflineParityEntryId => "empty_mirror_offline_parity_entry_id",
            Self::ForbiddenMaterial => "forbidden_material",
        }
    }
}

impl fmt::Display for M5ExactBuildSupportResolutionError {
...
impl Error for M5ExactBuildSupportResolutionError {}

fn form_tokens(forms: &[M5ExactBuildSupportResolutionForm]) -> Vec<String> {
    forms.iter().map(|f| f.as_str().to_owned()).collect()
}

fn covers_all_resolution_forms(forms: &[M5ExactBuildSupportResolutionForm]) -> bool {
    let present: BTreeSet<M5ExactBuildSupportResolutionForm> = forms.iter().copied().collect();
    M5ExactBuildSupportResolutionForm::ALL
        .iter()
...
pub fn exact_build_symbolication_object_is_complete(
    source: M5SymbolicationFidelityKind,
...
pub fn artifact_diff_stays_deterministic(
    scope: M5MirrorOfflineParityScope,
...
pub fn resolve_exact_build_symbolication_entry(
    input: M5ExactBuildSymbolicationEntryResolutionInput,
) -> Result<M5ResolvedExactBuildSymbolicationEntry, M5ExactBuildSupportResolutionError> {
    if input.entry_id.trim().is_empty() {
        return Err(M5ExactBuildSupportResolutionError::EmptyExactBuildSymbolicationEntryId);
    }
    ...
    {
        return Err(M5ExactBuildSupportResolutionError::ForbiddenMaterial);
    }

    let all_forms = covers_all_resolution_forms(&input.resolution_form_coverage);
    let object_complete = exact_build_symbolication_object_is_complete(
    ...
    let degrade_reason = if input.token_name.trim().is_empty() {
        ...
        Some(
            M5ExactBuildSymbolicationEntryDegradeReason::CacheTrustNotDisclosedForSharedCacheSource,
        )
    ...
    let next_action = match degrade_reason {
        ...
        None => M5ExactBuildSupportNextAction::ExpandRebuildMeaning,
    };

    Ok(M5ResolvedExactBuildSymbolicationEntry {
        ...
        exact_build_symbolication_object_complete: object_complete,
...
pub fn resolve_mirror_offline_parity_entry(
    input: M5MirrorOfflineParityEntryResolutionInput,
) -> Result<M5ResolvedMirrorOfflineParityEntry, M5ExactBuildSupportResolutionError> {
    if input.entry_id.trim().is_empty() {
        return Err(M5ExactBuildSupportResolutionError::EmptyMirrorOfflineParityEntryId);
    }
    if string_is_forbidden(&input.entry_id)
    ...
    let degrade_reason = if input.token_name.trim().is_empty() {
        Some(M5MirrorOfflineParityEntryDegradeReason::RegistryTokenUnstated)
    } else if !input.surface_context.is_resolved() {
        ...
        Some(M5MirrorOfflineParityEntryDegradeReason::ProofStale)
    } else {
        None
    };
    ...
    let next_action = match degrade_reason {
        Some(reason) => reason.next_action(),
        None => M5ExactBuildSupportNextAction::TraceCanonicalRegistry,
    };

    Ok(M5ResolvedMirrorOfflineParityEntry {
        entry_id: input.entry_id,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesRow {
    /// Consumer surface this row projects onto.
    pub consumer_surface: M5SymbolicationMirrorParityRegistriesConsumerSurface,
    ...
    pub anatomy_parts: Vec<M5ExactBuildSupportAnatomyPart>,
    /// Export fields exposed (must include the mandatory five).
    pub export_fields: Vec<M5ExactBuildSupportExportField>,
    /// Downgrade triggers that apply to this row.
    pub downgrade_triggers: Vec<M5BuildLaneDowngradeTrigger>,
    /// Resolved clean-room-rebuild-lane-registry examples.
    pub exact_build_symbolication_entries: Vec<M5ResolvedExactBuildSymbolicationEntry>,
    /// Resolved artifact-diff-packet examples.
    pub mirror_offline_parity_entries: Vec<M5ResolvedMirrorOfflineParityEntry>,
...
impl M5SymbolicationMirrorParityRegistriesRow {
    fn declares_mandatory_anatomy(&self) -> bool {
        let present: BTreeSet<M5ExactBuildSupportAnatomyPart> =
            self.anatomy_parts.iter().copied().collect();
        M5ExactBuildSupportAnatomyPart::MANDATORY
            .iter()
            .all(|part| present.contains(part))
    }

    fn declares_mandatory_export_fields(&self) -> bool {
        let present: BTreeSet<M5ExactBuildSupportExportField> =
            self.export_fields.iter().copied().collect();
        M5ExactBuildSupportExportField::MANDATORY
            .iter()
    ...
    /// source.
    fn manifest_is_honest(ex: &M5ResolvedExactBuildSymbolicationEntry) -> bool {
        !ex.is_clean()
            || (ex.bound_to_registry
                && ex.rebuild_source_is_classified
                && ex.exact_build_symbolication_object_complete
    ...
    fn sidecar_manifest_is_honest(ex: &M5ResolvedMirrorOfflineParityEntry) -> bool {
        !ex.is_clean()
    ...
    fn examples_are_honest(&self) -> bool {
        self.exact_build_symbolication_entries
            .iter()
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesVocabularySet {
    ...
    pub exact_build_symbolication_degrade_reasons: Vec<String>,
    /// Sidecar-completeness-manifest-entry degrade-reason tokens.
    pub mirror_offline_parity_degrade_reasons: Vec<String>,
    /// Anatomy-part tokens.
...
impl M5SymbolicationMirrorParityRegistriesVocabularySet {
    /// Builds the canonical vocabulary set from the typed `ALL` arrays.
    pub fn canonical() -> Self {
        Self {
            semantic_roles: tokens(&M5BuildLaneTrustRole::ALL, |v| v.as_str()),
            resolution_forms: tokens(&M5ExactBuildSupportResolutionForm::ALL, |v| v.as_str()),
            rebuild_source_kinds: tokens(&M5SymbolicationFidelityKind::ALL, |v| v.as_str()),
            diff_scopes: tokens(&M5MirrorOfflineParityScope::ALL, |v| v.as_str()),
            surface_contexts: tokens(&M5ExactBuildSupportSurfaceContext::ALL, |v| v.as_str()),
            exact_build_symbolication_degrade_reasons: tokens(
                &M5ExactBuildSymbolicationEntryDegradeReason::ALL,
                |v| v.as_str(),
            ),
            mirror_offline_parity_degrade_reasons: tokens(
                &M5MirrorOfflineParityEntryDegradeReason::ALL,
                |v| v.as_str(),
            ),
            anatomy_parts: tokens(&M5ExactBuildSupportAnatomyPart::ALL, |v| v.as_str()),
            next_actions: tokens(&M5ExactBuildSupportNextAction::ALL, |v| v.as_str()),
            export_fields: tokens(&M5ExactBuildSupportExportField::ALL, |v| v.as_str()),
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesGovernanceReview {
    /// The clean-room-rebuild registry names a canonical token, semantic role, and input source for every entry.
    pub exact_build_symbolication_registry_names_token_role_and_source: bool,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesConsumerProjection {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesProofFreshness {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesReleasePosture {
...
/// Constructor input for [`M5SymbolicationMirrorParityRegistriesPacket::new`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct M5SymbolicationMirrorParityRegistriesPacketInput {
    /// Stable packet id.
    pub packet_id: String,
    /// Human-readable registries label.
    pub registries_label: String,
    /// Registry rows.
    pub registry_rows: Vec<M5SymbolicationMirrorParityRegistriesRow>,
    /// Frozen controlled-vocabulary set.
    pub vocabulary_set: M5SymbolicationMirrorParityRegistriesVocabularySet,
    /// Governance-review block.
    pub governance_review: M5SymbolicationMirrorParityRegistriesGovernanceReview,
    /// Consumer projection block.
    pub consumer_projection: M5SymbolicationMirrorParityRegistriesConsumerProjection,
    /// Proof freshness block.
    pub proof_freshness: M5SymbolicationMirrorParityRegistriesProofFreshness,
    /// Release and support parity posture.
    pub release_posture: M5SymbolicationMirrorParityRegistriesReleasePosture,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct M5SymbolicationMirrorParityRegistriesPacket {
    /// Record kind; must equal [`M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_RECORD_KIND`].
    pub record_kind: String,
    /// Schema version; must equal [`M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_SCHEMA_VERSION`].
...
impl M5SymbolicationMirrorParityRegistriesPacket {
    /// Builds a registries packet from stable-lane input.
    pub fn new(input: M5SymbolicationMirrorParityRegistriesPacketInput) -> Self {
        Self {
            record_kind: M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_RECORD_KIND.to_owned(),
            schema_version: M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_SCHEMA_VERSION,
    ...
    pub fn validate(&self) -> Vec<M5SymbolicationMirrorParityRegistriesViolation> {
        let mut violations = Vec::new();

        if self.record_kind != M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_RECORD_KIND {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::WrongRecordKind);
        }
        if self.schema_version != M5_SYMBOLICATION_MIRROR_PARITY_REGISTRIES_SCHEMA_VERSION {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::WrongSchemaVersion);
        }
        ...
        {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::MissingIdentity);
        }

        validate_source_contracts(self, &mut violations);
        if !self.vocabulary_set.matches_canonical() {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::VocabularySetDrift);
        }
        ...
        if json_contains_forbidden_material(&serde_json::to_value(self).expect(
            ...
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::RawMaterialInExport);
        }
    ...
    pub fn render_matrix_csv(&self) -> String {
        ...
        out.push_str(
            "consumer_surface,qualification,owner,exact_build_symbolication_entries,mirror_offline_parity_entries,degrade_reasons,downgrade_triggers\n",
        );
        for row in &self.registry_rows {
            ...
            out.push_str(&format!(
                ...
                row.exact_build_symbolication_entries.len(),
                row.mirror_offline_parity_entries.len(),
                degrades.join("|"),
    ...
    pub fn render_exact_build_symbolication_table(&self) -> String {
        let mut out = String::new();
        out.push_str(
        ...
        out.push_str("| --- | --- | --- | --- | --- | --- |\n");
        for row in &self.registry_rows {
            for ex in &row.exact_build_symbolication_entries {
                if !ex.is_clean() {
                    continue;
                }
                out.push_str(&format!(
...
#[derive(Debug)]
pub enum M5SymbolicationMirrorParityRegistriesArtifactError {
    /// Support export failed to parse.
    SupportExport(serde_json::Error),
    /// Support export failed validation.
    Validation(Vec<M5SymbolicationMirrorParityRegistriesViolation>),
}

impl fmt::Display for M5SymbolicationMirrorParityRegistriesArtifactError {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
...
impl Error for M5SymbolicationMirrorParityRegistriesArtifactError {}

/// Validation failures emitted by [`M5SymbolicationMirrorParityRegistriesPacket::validate`].
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum M5SymbolicationMirrorParityRegistriesViolation {
    ...
    ExactBuildSymbolicationResolutionNotProven,
...
impl M5SymbolicationMirrorParityRegistriesViolation {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ExactBuildSymbolicationResolutionNotProven => {
                "exact_build_symbolication_resolution_not_proven"
            }
...
pub fn current_stable_m5_exact_build_symbolication_and_mirror_offline_parity_registries_export(
) -> Result<
    M5SymbolicationMirrorParityRegistriesPacket,
    M5SymbolicationMirrorParityRegistriesArtifactError,
> {
    let packet: M5SymbolicationMirrorParityRegistriesPacket = serde_json::from_str(include_str!(
        concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../artifacts/release/m5-exact-build-symbolication-and-mirror-offline-parity-registries-proof/support_export.json"
        )
    ))
    .map_err(M5SymbolicationMirrorParityRegistriesArtifactError::SupportExport)?;
    let violations = packet.validate();
    if violations.is_empty() {
        Ok(packet)
    } else {
        Err(M5SymbolicationMirrorParityRegistriesArtifactError::Validation(violations))
    }
}

fn validate_source_contracts(
    packet: &M5SymbolicationMirrorParityRegistriesPacket,
    violations: &mut Vec<M5SymbolicationMirrorParityRegistriesViolation>,
) {
    ...
    for required in [
        ...
        if !refs.contains(required) {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::MissingSourceContracts);
            return;
        }
    }
}
...
fn validate_registry_rows(
    ...
    if packet.registry_rows.is_empty() {
        violations.push(M5SymbolicationMirrorParityRegistriesViolation::NoRegistryRows);
        return;
    }
    for row in &packet.registry_rows {
        ...
        {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::RegistryRowIncomplete);
        }
        if !row.declares_mandatory_anatomy() {
            violations
                .push(M5SymbolicationMirrorParityRegistriesViolation::MandatoryAnatomyMissing);
        }
        if !row.declares_mandatory_export_fields() {
            violations
                .push(M5SymbolicationMirrorParityRegistriesViolation::MandatoryExportFieldMissing);
        }
        let refs: BTreeSet<&str> = row
            ...
            .map(String::as_str)
            .collect();
        if !refs.contains(M5_EXACT_BUILD_SYMBOLICATION_DOMAIN_SCHEMA_REF)
            || !refs.contains(M5_MIRROR_OFFLINE_PARITY_DOMAIN_SCHEMA_REF)
        {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::DomainSchemaRefMissing);
        }
        if row.exact_build_symbolication_entries.is_empty()
            || row.mirror_offline_parity_entries.is_empty()
        {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::ExamplesMissing);
        }
        if !row.examples_are_honest() {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::DishonestExample);
        }
        if !row.honours_invariants() {
            violations.push(M5SymbolicationMirrorParityRegistriesViolation::RowInvariantViolated);
        }
    }
}
...
fn validate_governance_review(
    ...
    for ok in [
        review.exact_build_symbolication_registry_names_token_role_and_source,
        ...
        if !ok {
            violations
                .push(M5SymbolicationMirrorParityRegistriesViolation::GovernanceReviewIncomplete);
            return;
        }
    }
}
...
fn validate_consumer_projection(
    ...
    for ok in [
        ...
        if !ok {
            violations
                .push(M5SymbolicationMirrorParityRegistriesViolation::ConsumerProjectionIncomplete);
            return;
        }
    }
}
...
fn validate_proof_freshness(
    ...
    {
        violations.push(M5SymbolicationMirrorParityRegistriesViolation::ProofFreshnessIncomplete);
    }
}
...
fn validate_release_posture(
    ...
    {
        violations.push(M5SymbolicationMirrorParityRegistriesViolation::ReleasePostureIncomplete);
    }
}
...
fn validate_acceptance_criteria(
    ...
    let manifests = || {
        packet
            .registry_rows
            .iter()
            .flat_map(|row| row.exact_build_symbolication_entries.iter())
    };
    let sidecars = || {
        packet
            .registry_rows
            .iter()
            .flat_map(|row| row.mirror_offline_parity_entries.iter())
    };
    ...
    let clean_surfaces: BTreeSet<String> = manifests()
        ...
        .collect();
    let sources_covered = M5SymbolicationFidelityKind::CANONICAL_SOURCES
        .iter()
        .all(|k| clean_sources.contains(k.as_str()));
    let first_surfaces_covered = M5ExactBuildSupportSurfaceContext::FIRST_CONSUMERS
        .iter()
    ...
    let no_clean_incomplete =
        !manifests().any(|ex| ex.is_clean() && !ex.exact_build_symbolication_object_complete);
    if !(sources_covered
    ...
    let clean_sidecar_scopes: BTreeSet<String> = sidecars()
        ...
        .collect();
    let sidecar_scopes_covered = M5MirrorOfflineParityScope::CANONICAL_SCOPES
        .iter()
    ...
    {
        violations
            .push(M5SymbolicationMirrorParityRegistriesViolation::ArtifactDiffDeterminismNotProven);
    }
}
