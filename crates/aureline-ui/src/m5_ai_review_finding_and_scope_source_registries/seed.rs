//! Canonical seed builders for the M5 line-ai_review_finding_record and line-downgrade-packet registries packet.
//!
//! These builders are the single producer of the checked-in support export and the narrowed fixtures.
//! The headless emitter and the inline tests both call them so the in-code registries, the artifact, and the
//! fixtures never drift. Every resolved example is built by calling the real resolvers so the packet can only
//! carry projections the resolvers actually produce. Clean line-ai_review_finding_record and line-downgrade-packet entries
//! are built so the one typed line-ai_review_finding_record object resolving per line, lines never widening without
...
pub const M5_AI_REVIEW_FINDING_AND_SCOPE_SOURCE_REGISTRIES_PACKET_ID: &str =
    "m5-ai-review-finding-and-scope-source-registries:stable:0001";
...
fn ai_review_finding_record(
    input: M5AiReviewFindingRecordEntryResolutionInput,
) -> M5ResolvedAiReviewFindingRecordEntry {
    resolve_ai_review_finding_record_entry(input)
        .expect("seed line-ai_review_finding_record entry resolves")
}

fn downgrade(input: M5ScopeSourceDiffEntryResolutionInput) -> M5ResolvedScopeSourceDiffEntry {
    resolve_scope_source_diff_entry(input).expect("seed line-downgrade-packet entry resolves")
}

fn all_forms() -> Vec<M5AiReviewFindingRecordResolutionForm> {
    M5AiReviewFindingRecordResolutionForm::ALL.to_vec()
}

// -- Clean line-ai_review_finding_record entries (typed object, rollback / diagnostics preserved, bound to the registry) --

#[allow(clippy::too_many_arguments)]
fn clean_ai_review_finding_record_base(
    entry_id: &str,
    line_binding_id: &str,
    token_name: &str,
    semantic_role: M5AiReviewAssistRole,
    report_section: M5AiReviewFindingRecordKind,
    surface_context: M5AiReviewFindingRecordSurfaceContext,
...
) -> M5AiReviewFindingRecordEntryResolutionInput {
    M5AiReviewFindingRecordEntryResolutionInput {
...
fn ai_review_finding_record_correctness_bug_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    ai_review_finding_record(clean_ai_review_finding_record_base(
        "ai_review_finding_record:shiproom:dogfood-core-team-canary",
        "launch.line.core-team-canary",
        "line.ai_review_finding_record.core_team_canary",
        M5AiReviewAssistRole::FindingClassification,
        M5AiReviewFindingRecordKind::CorrectnessBug,
        M5AiReviewFindingRecordSurfaceContext::ShiproomSurface,
...
fn ai_review_finding_record_security_risk_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    ai_review_finding_record(clean_ai_review_finding_record_base(
        "ai_review_finding_record:release-center:migration-alpha",
        "launch.line.migration-alpha",
        "line.ai_review_finding_record.security_risk",
        M5AiReviewAssistRole::AnalyzedScopeDisclosure,
        M5AiReviewFindingRecordKind::SecurityRisk,
        M5AiReviewFindingRecordSurfaceContext::ReleaseCenterSurface,
...
fn ai_review_finding_record_performance_concern_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    ai_review_finding_record(clean_ai_review_finding_record_base(
        "ai_review_finding_record:program-governance:extension-author",
        "launch.line.extension-author",
        "line.ai_review_finding_record.performance_concern",
        M5AiReviewAssistRole::PublishDestinationDisclosure,
        M5AiReviewFindingRecordKind::PerformanceConcern,
        M5AiReviewFindingRecordSurfaceContext::ProgramGovernanceSurface,
...
fn ai_review_finding_record_maintainability_smell_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    // A design-partner preview line is public-facing and keeps its support language matched to line proof.
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:executive-steering:design-partner-preview",
        "launch.line.design-partner-preview",
        "line.ai_review_finding_record.maintainability_smell",
        M5AiReviewAssistRole::FindingClassification,
        M5AiReviewFindingRecordKind::MaintainabilitySmell,
        M5AiReviewFindingRecordSurfaceContext::ExecutiveSteeringSurface,
    ...
    ai_review_finding_record(base)
}

fn ai_review_finding_record_test_gap_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    // A public preview line is public-facing and keeps its support language matched to line proof.
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:support:public-preview",
        "launch.line.public-preview",
        "line.ai_review_finding_record.test_gap",
        M5AiReviewAssistRole::AnalyzedScopeDisclosure,
        M5AiReviewFindingRecordKind::TestGap,
        M5AiReviewFindingRecordSurfaceContext::SupportOrExportForm,
...
fn ai_review_finding_record_style_nit_clean() -> M5ResolvedAiReviewFindingRecordEntry {
    ai_review_finding_record(clean_ai_review_finding_record_base(
        "ai_review_finding_record:release-center:certified-journey",
        "launch.line.certified-journey",
        "line.ai_review_finding_record.style_nit",
        M5AiReviewAssistRole::LocalVersusProviderState,
        M5AiReviewFindingRecordKind::StyleNit,
        M5AiReviewFindingRecordSurfaceContext::ReleaseCenterSurface,
...
// -- Degraded line-ai_review_finding_record entries ---------------------------------------------------------

/// Degraded ai_review_finding_record entry: the resolved ai_review_finding_record object is incomplete — the bundle IDs are unstated.
fn ai_review_finding_record_object_incomplete() -> M5ResolvedAiReviewFindingRecordEntry {
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:shiproom:incomplete",
        "launch.line.core-team-canary",
        "line.ai_review_finding_record.core_team_canary",
        M5AiReviewAssistRole::FindingClassification,
        M5AiReviewFindingRecordKind::CorrectnessBug,
...
/// Degraded ai_review_finding_record entry: the line's rollback and diagnostics posture is not preserved before widening —
...
fn ai_review_finding_record_widen_fold() -> M5ResolvedAiReviewFindingRecordEntry {
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:release-center:widen-fold",
        "launch.line.migration-alpha",
        "line.ai_review_finding_record.security_risk",
        M5AiReviewAssistRole::AnalyzedScopeDisclosure,
        M5AiReviewFindingRecordKind::SecurityRisk,
...
/// Degraded ai_review_finding_record entry: the behavior is a hand-copied per-entry assumption instead of tracing to the
/// registry.
fn ai_review_finding_record_unbound() -> M5ResolvedAiReviewFindingRecordEntry {
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:executive-steering:unbound",
        "launch.line.certified-journey",
        "line.ai_review_finding_record.style_nit",
        M5AiReviewAssistRole::LocalVersusProviderState,
        M5AiReviewFindingRecordKind::StyleNit,
...
/// Degraded ai_review_finding_record entry: the canonical registry token name is unstated.
fn ai_review_finding_record_token_unstated() -> M5ResolvedAiReviewFindingRecordEntry {
    let mut base = clean_ai_review_finding_record_base(
        "ai_review_finding_record:program-governance:token-unstated",
        "launch.line.extension-author",
        "  ",
        M5AiReviewAssistRole::PublishDestinationDisclosure,
        M5AiReviewFindingRecordKind::PerformanceConcern,
...
fn clean_downgrade_base(
    ...
    token_name: &str,
    semantic_role: M5AiReviewAssistRole,
    comparison_scope: M5ScopeSourceDiffScope,
    surface_context: M5AiReviewFindingRecordSurfaceContext,
...
) -> M5ScopeSourceDiffEntryResolutionInput {
    M5ScopeSourceDiffEntryResolutionInput {
        entry_id: entry_id.to_owned(),
        ...
        keeps_scope_source_diff_visible: true,
...
fn downgrade_dogfood_ring_clean() -> M5ResolvedScopeSourceDiffEntry {
    ...
    let mut base = clean_downgrade_base(
        ...
        M5AiReviewAssistRole::FindingClassification,
        M5ScopeSourceDiffScope::AnalyzedDiffScopeBinding,
        M5AiReviewFindingRecordSurfaceContext::ShiproomSurface,
...
fn downgrade_rehearsal_currency_clean() -> M5ResolvedScopeSourceDiffEntry {
    downgrade(clean_downgrade_base(
        "downgrade:program-governance:rehearsal-currency",
        "launch.line.extension-author",
        "line.downgrade.performance_concern",
        M5AiReviewAssistRole::PublishDestinationDisclosure,
        M5ScopeSourceDiffScope::RepoInstructionSourceBinding,
        M5AiReviewFindingRecordSurfaceContext::ProgramGovernanceSurface,
...
fn downgrade_go_no_go_signoff_clean() -> M5ResolvedScopeSourceDiffEntry {
    downgrade(clean_downgrade_base(
        "downgrade:release-center:go-no-go-signoff",
        "launch.line.certified-journey",
        "line.downgrade.style_nit",
        M5AiReviewAssistRole::LocalVersusProviderState,
        M5ScopeSourceDiffScope::EvidenceAnchorBinding,
        M5AiReviewFindingRecordSurfaceContext::ReleaseCenterSurface,
...
fn downgrade_support_ahead() -> M5ResolvedScopeSourceDiffEntry {
    let mut base = clean_downgrade_base(
        "downgrade:shiproom:support-ahead",
        "launch.line.public-preview",
        "line.downgrade.test_gap",
        M5AiReviewAssistRole::AnalyzedScopeDisclosure,
        M5ScopeSourceDiffScope::AnalyzedDiffScopeBinding,
        M5AiReviewFindingRecordSurfaceContext::ShiproomSurface,
...
/// incomplete.
fn downgrade_form_incomplete() -> M5ResolvedScopeSourceDiffEntry {
    let mut base = clean_downgrade_base(
    ...
    base.resolution_form_coverage = vec![M5AiReviewFindingRecordResolutionForm::CanonicalObject];
    downgrade(base)
}

/// Degraded downgrade entry: the downgrade scope is unclassified.
fn comparison_scope_source_unclassified() -> M5ResolvedScopeSourceDiffEntry {
    downgrade(clean_downgrade_base(
        "downgrade:executive-steering:scope-unclassified",
        "launch.line.design-partner-preview",
        "line.downgrade.maintainability_smell",
        M5AiReviewAssistRole::FindingClassification,
        M5ScopeSourceDiffScope::ScopeSourceUnclassified,
        M5AiReviewFindingRecordSurfaceContext::ExecutiveSteeringSurface,
...
#[allow(clippy::too_many_arguments)]
fn base_row(
    consumer_surface: M5AiReviewFindingAndScopeSourceRegistriesConsumerSurface,
    owner_role: &str,
    scope_summary: &str,
    proof_ref: &str,
    downgrade_triggers: Vec<M5AiReviewAssistDowngradeTrigger>,
    ai_review_finding_record_entries: Vec<M5ResolvedAiReviewFindingRecordEntry>,
    scope_source_diff_entries: Vec<M5ResolvedScopeSourceDiffEntry>,
) -> M5AiReviewFindingAndScopeSourceRegistriesRow {
    M5AiReviewFindingAndScopeSourceRegistriesRow {
        consumer_surface,
        ...
        anatomy_parts: M5AiReviewFindingRecordAnatomyPart::ALL.to_vec(),
        export_fields: M5AiReviewFindingRecordExportField::ALL.to_vec(),
        downgrade_triggers,
        ...
        collapses_distinct_scope_source_diff_classes_into_one_lane: false,
    }
}

fn registry_rows() -> Vec<M5AiReviewFindingAndScopeSourceRegistriesRow> {
    ...
    vec![
        base_row(
            ...
            vec![
                ai_review_finding_record_correctness_bug_clean(),
                ai_review_finding_record_object_incomplete(),
            ],
        ...
        base_row(
            ...
            vec![ai_review_finding_record_security_risk_clean(), ai_review_finding_record_widen_fold()],
            vec![downgrade_go_no_go_signoff_clean(), downgrade_form_incomplete()],
        ),
        base_row(
            C::SupportExportPacket,
            "Support owner",
            "Support resolves the successor-reference field while keeping its public-facing successor / exit claim matched to the closed support note and reports the scope-source-diff outcome; a manifest entry that is a hand-copied per-entry assumption and a diff on an unclassified diff scope degrade honestly",
            ...
            vec![
                ai_review_finding_record_maintainability_smell_clean(),
                ai_review_finding_record_unbound(),
            ],
            vec![comparison_scope_source_unclassified()],
        ),
        base_row(
            C::FindingRow,
            ...
            vec![
                ai_review_finding_record_performance_concern_clean(),
                ai_review_finding_record_token_unstated(),
            ],
        ...
        base_row(
            ...
            "Install / update renders the same resolved ai-review-finding-record and scope-source-diff truth the resolvers produced across the canonical, accessible, and audit resolution forms rather than a hand-copied class table; the export / rollback-route field and the disable-or-export-route-change diff stay inspectable off-renderer so no new install can still select a retired class",
        ...
        base_row(
            ...
            vec![ai_review_finding_record_test_gap_clean()],
            vec![downgrade_rehearsal_currency_clean()],
        ),
    ]
}

fn governance_review() -> M5AiReviewFindingAndScopeSourceRegistriesGovernanceReview {
    M5AiReviewFindingAndScopeSourceRegistriesGovernanceReview {
        ai_review_finding_record_registry_names_token_role_and_journey: true,
        line_resolves_to_typed_ai_review_finding_record_from_shared_registry: true,
        repo_bundle_toolchain_and_deployment_rows_published: true,
        lines_cannot_widen_without_rollback_and_diagnostics: true,
        scope_source_diff_keeps_proof_visible_and_binds_support_language: true,
        ...
        ai_review_finding_record_or_downgrade_drift_caught_before_release: true,
        every_row_declares_mandatory_anatomy: true,
        reuses_frozen_matrix_vocabulary: true,
    }
}

fn consumer_projection() -> M5AiReviewFindingAndScopeSourceRegistriesConsumerProjection {
    M5AiReviewFindingAndScopeSourceRegistriesConsumerProjection {
...
fn proof_freshness() -> M5AiReviewFindingAndScopeSourceRegistriesProofFreshness {
    M5AiReviewFindingAndScopeSourceRegistriesProofFreshness {
...
fn release_posture() -> M5AiReviewFindingAndScopeSourceRegistriesReleasePosture {
    M5AiReviewFindingAndScopeSourceRegistriesReleasePosture {
        proof_packet_ref: M5_AI_REVIEW_FINDING_AND_SCOPE_SOURCE_REGISTRIES_ARTIFACT_REF.to_owned(),
        line_audit_ref: M5_AI_REVIEW_FINDING_AND_SCOPE_SOURCE_REGISTRIES_REPORT_REF.to_owned(),
...
pub fn seeded_m5_ai_review_finding_and_scope_source_registries_ai_review_finding_record_beta_narrowed(
) -> M5AiReviewFindingAndScopeSourceRegistriesPacket {
    let mut packet = seeded_m5_ai_review_finding_and_scope_source_registries();
    packet.packet_id =
        "m5-ai-review-finding-and-scope-source-registries:snapshot-descriptor-beta:0001".to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
...
pub fn seeded_m5_ai_review_finding_and_scope_source_registries_scope_source_diff_preview_narrowed(
) -> M5AiReviewFindingAndScopeSourceRegistriesPacket {
    let mut packet = seeded_m5_ai_review_finding_and_scope_source_registries();
    packet.packet_id =
        "m5-ai-review-finding-and-scope-source-registries:scope-source-diff-preview:0001"
            .to_owned();
    let row = packet
        .registry_rows
        .iter_mut()
