...
fn clean_review_pack_record_input() -> M5ChangeIntentRecordEntryResolutionInput {
    M5ChangeIntentRecordEntryResolutionInput {
        ...
        report_section: M5ChangeIntentRecordKind::ChangedFilesScope,
        surface_context: M5ChangeIntentRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ChangeIntentRecordResolutionForm::ALL.to_vec(),
...
fn clean_downgrade_input() -> M5ChangeIntentResultEntryResolutionInput {
    M5ChangeIntentResultEntryResolutionInput {
        ...
        semantic_role: M5ChangeIntentRole::ProviderOwnershipDisclosure,
        comparison_scope: M5ChangeIntentResultScope::EvaluatedScopeBinding,
        surface_context: M5ChangeIntentRecordSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ChangeIntentRecordResolutionForm::ALL.to_vec(),
...
fn seeded_registries_validates() {
    let packet = seeded_m5_change_intent_record_and_start_work_registries();
...
fn review_pack_record_clean_names_meaning_and_is_bound() {
    ...
    assert_eq!(
        ...
        M5ChangeIntentRecordNextAction::ExpandCohortMeaning
    );
}
...
fn review_pack_record_unbound_and_unclassified_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ChangeIntentRecordKind::PackScopeUnclassified;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_object_incomplete_and_widen_fold_and_form_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.resolution_form_coverage = vec![M5ChangeIntentRecordResolutionForm::CanonicalObject];
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_public_facing_and_surface_and_proof_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ChangeIntentRecordKind::FullTreeScope;
    ...
    let mut input = clean_review_pack_record_input();
    input.surface_context = M5ChangeIntentRecordSurfaceContext::ContextUnknown;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_empty_id_and_forbidden_material_error() {
    ...
    assert_eq!(
        ...
        M5ChangeIntentRecordResolutionError::EmptyCohortDescriptorEntryId
    );
    ...
    assert_eq!(
        resolve_review_pack_record_entry(input).unwrap_err(),
        M5ChangeIntentRecordResolutionError::ForbiddenMaterial
    );
}
...
fn line_preserves_rollback_and_diagnostics_rejects_unpreserved() {
    ...
    assert!(!line_preserves_rollback_and_diagnostics_before_widening(
        M5ChangeIntentRecordKind::PackScopeUnclassified,
        true,
        false,
        true
    ));
...
fn downgrade_support_ahead_and_unclassified_degrade() {
    ...
    let mut input = clean_downgrade_input();
    input.comparison_scope = M5ChangeIntentResultScope::ChangeIntentResultUnclassified;
    assert_eq!(
...
fn downgrade_form_and_surface_and_id_and_material() {
    ...
    assert_eq!(
        ...
        M5ChangeIntentRecordResolutionError::EmptyCohortEvidencePacketEntryId
    );
...
fn vocabulary_set_is_canonical() {
    assert!(seeded_m5_change_intent_record_and_start_work_registries()
        .vocabulary_set
        .matches_canonical());
}
...
fn vocabulary_set_drift_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::VocabularySetDrift));
}
...
fn missing_source_contracts_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::MissingSourceContracts));
}
...
fn domain_schema_ref_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::DomainSchemaRefMissing));

    let mut packet = seeded_m5_change_intent_record_and_start_work_registries();
    packet.registry_rows[0]
        .source_contract_refs
        .retain(|r| r != M5_START_WORK_SHEET_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::DomainSchemaRefMissing));
}
...
fn mandatory_anatomy_missing_fails() {
    ...
    packet.registry_rows[0]
        .anatomy_parts
        .retain(|p| *p != M5ChangeIntentRecordAnatomyPart::Identity);
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::MandatoryAnatomyMissing));
}
...
fn mandatory_export_field_missing_fails() {
    ...
    packet.registry_rows[0]
        .export_fields
        .retain(|f| *f != M5ChangeIntentRecordExportField::CohortArchetypes);
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::MandatoryExportFieldMissing));
}
...
fn examples_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::ExamplesMissing));
}
...
fn dishonest_clean_example_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::DishonestExample));
}
...
fn row_invariant_violation_fails() {
    for mutate in 0u8..4 {
        ...
        assert!(packet
            .validate()
            .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::RowInvariantViolated));
    }
}
...
fn governance_review_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::GovernanceReviewIncomplete));
}
...
fn consumer_projection_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::ConsumerProjectionIncomplete));
}
...
fn proof_freshness_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::ProofFreshnessIncomplete));
}
...
fn release_posture_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::ReleasePostureIncomplete));
}
...
fn injected_raw_material_is_rejected() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ChangeIntentRecordAndResultRegistriesViolation::RawMaterialInExport));
}

#[test]
fn export_carries_no_forbidden_raw_material() {
    let json = seeded_m5_change_intent_record_and_start_work_registries().export_safe_json();
...
fn checked_support_export_validates_and_matches_seed() {
    let from_disk = current_stable_m5_change_intent_record_and_start_work_registries_export()
        .expect(
...
fn narrowed_variants_validate_and_keep_rows_visible() {
    ...
    let row = preview
        .registry_rows
        .iter()
        .find(|r| r.consumer_surface == M5ChangeIntentConsumerSurface::StartWorkSheet)
        .unwrap();
...
fn checked_narrowed_fixtures_validate_and_match_seed_builders() {
    let beta: M5ChangeIntentRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-change-intent-record-and-start-work-registries/change_intent_record_beta_narrowed.json"
    )))
    ...
    let preview: M5ChangeIntentRecordAndResultRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-change-intent-record-and-start-work-registries/start_work_sheet_preview_narrowed.json"
    )))
