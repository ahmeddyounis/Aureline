...
fn clean_review_pack_record_input() -> M5ResolveCloseSheetEntryResolutionInput {
    M5ResolveCloseSheetEntryResolutionInput {
        ...
        semantic_role: M5ChangeIntentRole::ProviderOwnershipDisclosure,
        report_section: M5ResolveCloseSheetKind::ChangedFilesScope,
        surface_context: M5ResolveCloseSheetSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ResolveCloseSheetResolutionForm::ALL.to_vec(),
...
fn clean_downgrade_input() -> M5ResolveCloseOutcomeEntryResolutionInput {
    M5ResolveCloseOutcomeEntryResolutionInput {
        ...
        semantic_role: M5ChangeIntentRole::ProviderOwnershipDisclosure,
        comparison_scope: M5ResolveCloseOutcomeScope::EvaluatedScopeBinding,
        surface_context: M5ResolveCloseSheetSurfaceContext::ShiproomSurface,
        resolution_form_coverage: M5ResolveCloseSheetResolutionForm::ALL.to_vec(),
...
fn seeded_registries_validates() {
    let packet = seeded_m5_resolve_close_sheet_registries();
...
fn review_pack_record_clean_names_meaning_and_is_bound() {
    ...
    assert_eq!(resolved.semantic_role, "provider_ownership_disclosure");
    ...
    assert_eq!(
        ...
        M5ResolveCloseSheetNextAction::ExpandCohortMeaning
    );
}
...
fn review_pack_record_unbound_and_unclassified_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ResolveCloseSheetKind::PackScopeUnclassified;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_object_incomplete_and_widen_fold_and_form_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.resolution_form_coverage = vec![M5ResolveCloseSheetResolutionForm::CanonicalObject];
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_public_facing_and_surface_and_proof_degrade() {
    ...
    let mut input = clean_review_pack_record_input();
    input.report_section = M5ResolveCloseSheetKind::FullTreeScope;
    ...
    let mut input = clean_review_pack_record_input();
    input.surface_context = M5ResolveCloseSheetSurfaceContext::ContextUnknown;
    assert_eq!(
        resolve_review_pack_record_entry(input)
            .unwrap()
            .degrade_reason,
...
fn review_pack_record_empty_id_and_forbidden_material_error() {
    ...
    assert_eq!(
        ...
        M5ResolveCloseSheetResolutionError::EmptyCohortDescriptorEntryId
    );
    ...
    assert_eq!(
        resolve_review_pack_record_entry(input).unwrap_err(),
        M5ResolveCloseSheetResolutionError::ForbiddenMaterial
    );
}
...
fn line_preserves_rollback_and_diagnostics_rejects_unpreserved() {
    ...
    assert!(!line_preserves_rollback_and_diagnostics_before_widening(
        M5ResolveCloseSheetKind::PackScopeUnclassified,
        true,
        false,
        true
    ));
...
fn downgrade_support_ahead_and_unclassified_degrade() {
    ...
    let mut input = clean_downgrade_input();
    input.comparison_scope = M5ResolveCloseOutcomeScope::ChangeIntentResultUnclassified;
    assert_eq!(
...
fn downgrade_form_and_surface_and_id_and_material() {
    ...
    assert_eq!(
        ...
        M5ResolveCloseSheetResolutionError::EmptyCohortEvidencePacketEntryId
    );
...
fn vocabulary_set_is_canonical() {
    assert!(seeded_m5_resolve_close_sheet_registries()
        .vocabulary_set
        .matches_canonical());
}
...
fn vocabulary_set_drift_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::VocabularySetDrift));
}
...
fn missing_source_contracts_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::MissingSourceContracts));
}
...
fn domain_schema_ref_missing_fails() {
    ...
    packet.registry_rows[0]
        ...
        .retain(|r| r != M5_CHANGE_INTENT_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::DomainSchemaRefMissing));

    let mut packet = seeded_m5_resolve_close_sheet_registries();
    packet.registry_rows[0]
        .source_contract_refs
        .retain(|r| r != M5_RESOLVE_CLOSE_SHEET_DOMAIN_SCHEMA_REF);
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::DomainSchemaRefMissing));
}
...
fn mandatory_anatomy_missing_fails() {
    ...
    packet.registry_rows[0]
        .anatomy_parts
        .retain(|p| *p != M5ResolveCloseSheetAnatomyPart::Identity);
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::MandatoryAnatomyMissing));
}
...
fn mandatory_export_field_missing_fails() {
    ...
    packet.registry_rows[0]
        .export_fields
        .retain(|f| *f != M5ResolveCloseSheetExportField::CohortArchetypes);
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::MandatoryExportFieldMissing));
}
...
fn examples_missing_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::ExamplesMissing));
}
...
fn dishonest_clean_example_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::DishonestExample));
}
...
fn row_invariant_violation_fails() {
    for mutate in 0u8..4 {
        ...
        assert!(packet
            .validate()
            .contains(&M5ResolveCloseSheetRegistriesViolation::RowInvariantViolated));
    }
}
...
fn review_pack_record_not_proven_when_incomplete_example_removed() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::CohortDescriptorResolutionNotProven));
}
...
fn review_pack_result_integrity_not_proven_when_support_ahead_example_removed() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::CohortEvidenceIntegrityNotProven));
}
...
fn governance_review_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::GovernanceReviewIncomplete));
}
...
fn consumer_projection_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::ConsumerProjectionIncomplete));
}
...
fn proof_freshness_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::ProofFreshnessIncomplete));
}
...
fn release_posture_incomplete_fails() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::ReleasePostureIncomplete));
}
...
fn injected_raw_material_is_rejected() {
    ...
    assert!(packet
        .validate()
        .contains(&M5ResolveCloseSheetRegistriesViolation::RawMaterialInExport));
}

#[test]
fn export_carries_no_forbidden_raw_material() {
    let json = seeded_m5_resolve_close_sheet_registries().export_safe_json();
...
fn checked_support_export_validates_and_matches_seed() {
    let from_disk = current_stable_m5_resolve_close_sheet_registries_export().expect(
...
fn narrowed_variants_validate_and_keep_rows_visible() {
    let beta = seeded_m5_resolve_close_sheet_registries_review_pack_record_beta_narrowed();
    assert!(beta.validate().is_empty(), "{:?}", beta.validate());
    assert_eq!(beta.registry_rows.len(), 6);
    let row = beta
        .registry_rows
        .iter()
        .find(|r| r.consumer_surface == M5ChangeIntentConsumerSurface::WorkItemDetail)
        .unwrap();
    assert_eq!(row.qualification, M5ChangeIntentQualificationClass::Beta);

    let preview = seeded_m5_resolve_close_sheet_registries_review_pack_result_preview_narrowed();
    assert!(preview.validate().is_empty(), "{:?}", preview.validate());
    assert_eq!(preview.registry_rows.len(), 6);
    let row = preview
        .registry_rows
        .iter()
        .find(|r| r.consumer_surface == M5ChangeIntentConsumerSurface::ReviewDetail)
        .unwrap();
...
fn checked_narrowed_fixtures_validate_and_match_seed_builders() {
    let beta: M5ResolveCloseSheetRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-resolve-close-sheet-registries/resolve_close_sheet_beta_narrowed.json"
    )))
    ...
    let preview: M5ResolveCloseSheetRegistriesPacket = serde_json::from_str(include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../fixtures/teamwork/m5-resolve-close-sheet-registries/resolve_close_outcome_preview_narrowed.json"
    )))
...
fn implemented_lines_is_all_six_constrained_file_state_object_classes() {
    assert_eq!(IMPLEMENTED_LINES, M5ChangeIntentObject::ALL);
