//! Headless emitter for the M5 responsive-geometry / collapse-priority registries packet.
//!
//! The example is the only mint-from-truth path for the support export checked in under
//! `artifacts/release/m5-responsive-geometry-and-collapse-priority-registries-proof/`, its matrix CSV, the
...
use aureline_ui::m5_responsive_geometry_and_collapse_priority_registries::{
