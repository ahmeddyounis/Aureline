...
- Regenerator: `cargo run -p aureline-release --bin aureline_release_ship_version_bump_proposals_publish -- emit-artifact artifacts/release/m5/ship_version_bump_proposals_publish_target_review_sheets_auth_source_disclosure_dry_run_previews_and_rollout_ring_truth_across_m5_publication_lanes.json`
