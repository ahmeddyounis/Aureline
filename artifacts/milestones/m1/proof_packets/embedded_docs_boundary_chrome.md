# Proof packet: embedded docs/help boundary chrome

Purpose: anchor the embedded docs/help owner-origin chrome baseline and governed
system-browser handoff proof artifacts in one indexed location.
