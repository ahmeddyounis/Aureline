...
scorecard_id: archetype_scorecard:go_service_or_monorepo_slice
archetype_row_ref: archetype_row:go_service_or_monorepo_slice
public_label: Go service or monorepo slice
inherited_from_milestone: m3
title: Go service or monorepo slice archetype scorecard
owner: "@ahmeddyounis"
...
minimum_mode_matrix:
  - local_only
evidence_refs:
  - artifacts/compat/reference_workspace_rows.yaml#archetype_row:go_service_or_monorepo_slice
  - artifacts/compat/m3/reference_workspace_register.yaml#m3_reference_workspace:go_service
  - artifacts/compat/m3/reference_workspace_report.json#reference_workspace_report_row:go_service
  - artifacts/compat/m3/reference_workspace_badges.json#reference_workspace_badge:go_service_or_monorepo_slice
...
open_waivers:
  - waiver_id: waiver:archetype.go_service_or_monorepo_slice.first_beta_seed
    state: active
...
# Archetype scorecard: Go service or monorepo slice

This scorecard is the reviewer-facing readiness summary for
`archetype_row:go_service_or_monorepo_slice` in the M3 beta admission lane.
...
- a reference workspace, module set, and benchmark corpus row are current
  for the named Go toolchain;
