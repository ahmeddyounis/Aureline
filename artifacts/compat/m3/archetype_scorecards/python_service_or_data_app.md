...
scorecard_id: archetype_scorecard:python_service_or_data_app
archetype_row_ref: archetype_row:python_service_or_data_app
public_label: Python service or data app
inherited_from_milestone: m2
title: Python service or data app archetype scorecard
owner: "@ahmeddyounis"
...
# Archetype scorecard: Python service or data app
...
- the alpha Python wedge evidence remains current and unblocked;
- the seeded reference workspace boots, opens, searches, renames, runs
  tests, and supports debug on the current beta build, including the
  devcontainer or container mode; and
