...
This document describes the M05-018 notebook-aware search, outline, breadcrumb, and cell-target navigation data model that keeps notebook navigation honest about cell identity, scope, and degraded state.
