...
| LX    | `aureline-bench`, `aureline-largefile-proto`, `aureline-reactive-state`, `aureline-graph-proto`, `aureline-env`, `aureline-generated` (off the cone; explicit allowances listed below) |
...
| `aureline-generated`    | (no internal deps; off-cone generated-artifact governance matrix) |
