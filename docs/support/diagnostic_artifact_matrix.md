...
| `support.item.execution_context_summary` | toolchain versions, target class, resolver confidence, activator class, degraded state | `environment_adjacent` | metadata summary embedded; raw environment, full PATH, args, and file contents excluded |
