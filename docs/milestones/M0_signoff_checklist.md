...
| Subsystem contract cards published | Launch-critical subsystem cards exist, expose owned objects/dependencies/proof/gaps, and are reachable from the architecture packet | `docs/architecture/subsystem_contract_cards.md`, `docs/architecture/subsystem_dependency_overview.md`, `artifacts/architecture/subsystem_contract_cards/`, `artifacts/milestones/M0_architecture_pack/README.md` |
| Decision-forum charter pack seeded | Standing forum matrix, charter narrative, packet-template guide, and benchmark-council charter all exist together | `artifacts/governance/forum_matrix.yaml`, `docs/governance/forum_charters.md`, `docs/governance/forum_packet_templates.md`, `docs/governance/benchmark_council_charter.md` |
| Qualification and ring rules linked | Qualification matrix, version-skew register, install topology, validation-ring policy, and ring-history contract all exist together | `artifacts/compat/qualification_matrix_seed.yaml`, `artifacts/compat/version_skew_register.yaml`, `artifacts/release/install_topology_matrix.yaml`, `docs/release/ring_progression_policy.md`, `artifacts/release/ring_matrix.yaml`, `schemas/release/ring_history_packet.schema.json` |
