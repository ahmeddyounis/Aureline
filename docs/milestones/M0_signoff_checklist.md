...
| Requirement register present | The architecture packet still exposes the requirement-register slice and its canonical source | `artifacts/milestones/M0_architecture_pack/packet_index.yaml`, `.t2/docs/Aureline_PRD.md` |
