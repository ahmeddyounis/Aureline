...
- **Future conformance or compatibility rows to refresh before widening claim:**
  ...
  - ...
- **Cohort and archetype scorecard register:**
  - Derived register:
    `artifacts/milestones/m3/captures/cohort_archetype_scorecard_register.json`
  - Effective cohort and archetype support classes cited above SHOULD
    match the `effective_support_class` rows in the derived register.
    The register is regenerated by
